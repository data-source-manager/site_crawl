...
class TrMaaripParser(BaseParser):
    name = 'maarip'
    # 站点id
    site_id = "f9f2b1cb-13a5-45f6-a273-fd24ece722c2"
    # 站点名
    site_name = "东突厥斯坦教育与团结协会"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "f9f2b1cb-13a5-45f6-a273-fd24ece722c2", "source_name": "东突厥斯坦教育与团结协会", "direction": "tr", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d71f0-fe6f-11ec-a30b-d4619d029786", "新闻", "https://maarip.org/english/category/news/#", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="container-wrapper"]//h3/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content entry clearfix"]/*'
                                   '|//div[@class="entry-content entry clearfix"]//img'
                                   '|//div[@class="single-featured-image"]//img'
