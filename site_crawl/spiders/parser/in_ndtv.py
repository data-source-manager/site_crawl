...
class InNdtvParser(BaseParser):
    name = 'ndtv'
    
    # 站点id
    site_id = "61dcdedf-c021-7864-2dd6-1be9932c84ae"
    # 站点名
    site_name = "印度新德里电视"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "61dcdedf-c021-7864-2dd6-1be9932c84ae", "source_name": "印度新德里电视", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d7c40-fe6f-11ec-a30b-d4619d029786", "世界", "https://www.ndtv.com/world-news", "政治"),
            ("4a8d7c0e-fe6f-11ec-a30b-d4619d029786", "意见", "https://www.ndtv.com/opinion", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h2[@class="newsHdng"]/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//span[@itemprop="author"]/span/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@id="ins_storybody"]/*'
                                   '|//div[@id="ins_storybody"]//img') or []
