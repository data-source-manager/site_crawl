...
class Ru4ptParser(BaseParser):
    name = 'ru_4pt'
    
    # 站点id
    site_id = "f057ca35-d93b-1c53-6225-975024171e95"
    # 站点名
    site_name = "地缘政治网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "f057ca35-d93b-1c53-6225-975024171e95", "source_name": "地缘政治网", "direction": "ru", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8e0d7c-fe6f-11ec-a30b-d4619d029786", "文章", "http://www.4pt.su/en", "政治"),
        ]
    ]
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath('//div[@class="field-item even"]/a/text()').extract()
        if authors:
            for au in authors:
                if au.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="field-item even"]/*|//div[@class="field-item even"]/img')
        if news_tags:
