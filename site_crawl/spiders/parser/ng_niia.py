...
class NgNiIaParser(BaseParser):
    name = 'ng_niia'
    
    # 站点id
    site_id = "baf914c1-7b23-4b22-9985-63c4d0ed9e1e"
    # 站点名
    site_name = "尼日利亚国际问题研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "baf914c1-7b23-4b22-9985-63c4d0ed9e1e", "source_name": "尼日利亚国际问题研究所", "direction": "ng", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f1d20-fe6f-11ec-a30b-d4619d029786", "新闻", "https://niia.gov.ng/news/page/1/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="et_post_meta_wrapper"]/img|//div[@class="entry-content"]/*|'
                                   '//div[@class="entry-content"]/div/a[1]')
        if news_tags:
