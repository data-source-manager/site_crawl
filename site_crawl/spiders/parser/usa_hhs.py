...
class UsaHhsParser(BaseParser):
    name = 'usa_hhs'
    
    # 站点id
    site_id = "9591855a-1143-9b1a-f471-239a8c5b1186"
    # 站点名
    site_name = "美国卫生与公众服务部"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "9591855a-1143-9b1a-f471-239a8c5b1186", "source_name": "美国卫生与公众服务部", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("daf2e80c-eddd-3f0c-8bd0-cf24398ec9a4", "关于", "", "政治"),
            ("4a8f02f4-fe6f-11ec-a30b-d4619d029786", "关于/新闻", "https://www.hhs.gov/about/news/index.html?_wrapper_format=html&content_type=All&page=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="views-field-title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//div[@class="field field--name-field-uswds-body field--type-text-long field--label-hidden field--item"]/*')
        if news_tags:
