...
class TwKinmenParser(BaseParser):
    name = 'kinmen'
    
    # 站点id
    site_id = "b0bd6045-def8-49d3-9df8-ef9160c0ec1e"
    # 站点名
    site_name = "金门县政府"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "b0bd6045-def8-49d3-9df8-ef9160c0ec1e", "source_name": "金门县政府", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("bad0f129-afba-4845-9d23-2bc6698165b5", "金门新闻", "https://www.kinmen.gov.tw/News.aspx?n=98E3CA7358C89100&sms=BF7D6D478B935644", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="aspx"]/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="p"]/span/*|'
