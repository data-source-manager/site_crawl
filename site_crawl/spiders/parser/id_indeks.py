...
class IdIndeksParser(BaseParser):
    name = 'indeks'
    
    # 站点id
    site_id = "38fea9cf-90f1-4294-b3bb-34b26e6409e7"
    # 站点名
    site_name = "印度尼西亚罗盘报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "38fea9cf-90f1-4294-b3bb-34b26e6409e7", "source_name": "印度尼西亚罗盘报", "direction": "id", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d7498-fe6f-11ec-a30b-d4619d029786", "消息", "https://indeks.kompas.com/?site=news&page=1", "政治"),
        ]
    ]
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//meta[@name="content_author"]/@content').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="read__content"]/div/*'
                                   '|//div[@class="read__content"]//img'
                                   '|//div[@class="photo__wrap"]//img') or []
