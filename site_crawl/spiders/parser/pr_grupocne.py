...
class PrGruPoCneParser(BaseParser):
    name = 'pr_grupocne'
    
    # 站点id
    site_id = "9e8818e1-fcf8-42b8-8ffd-e6184fc38bfc"
    # 站点名
    site_name = "新经济中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9e8818e1-fcf8-42b8-8ffd-e6184fc38bfc", "source_name": "新经济中心", "direction": "pr", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("29c20f21-f30b-3cea-b7c2-a7c69748af8a", "出版物", "", "政治"),
            ("4a8f23ec-fe6f-11ec-a30b-d4619d029786", "出版物/报告", "https://grupocne.org/category/publications/reports/page/1/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            ...
            '//div[@class="wpb_column vc_column_container vc_col-sm-9"]//div[@class="wpb_wrapper"]/p/img')
        if news_tags:
