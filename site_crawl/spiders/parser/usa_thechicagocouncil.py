...
class UsaThechicagocouncilParser(BaseParser):
    name = 'thechicagocouncil'
    ...
    channel = [
        ...
        for board_id, board_name, board_url, board_theme in [
            ...
            ("7f4cc028-1993-460a-9b93-64e6207dec70", "评论与分析/伊沃·达尔德 (Ivo Daalder) 的世界评论", "https://globalaffairs.org/commentary-and-analysis/videos/worldreview", "政治"),
            ("9d325fe7-16f1-4044-9153-6da2a9971a25", "评论与分析/深盘播客", "https://globalaffairs.org/commentary-and-analysis/podcasts/deep-dish-global-affairs-podcast", "政治"),
            ("4a8c6418-fe6f-11ec-a30b-d4619d029786", "评论与分析/视频", "https://globalaffairs.org/commentary-and-analysis/watch-demand", "政治"),
            ("91329dbb-d80c-4e32-b655-c3ca00013d71", "过去的事件", "https://globalaffairs.org/events/past", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h2[@class="listing_teaser_title"]/a/@href|'
                                   '//div[@class="fs-carousel-viewport"]//div[@class="card_group_item_title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//article/header|'
                                   '//article/div[@class="entry-content"]/*|'
                                   '//figure[contains(@class,"video_detail")]/a|'
                                   '//div[@class="typography"]/*|'
                                   '//a[contains(@class,"event_detail_top_video")]')
        if news_tags:
    ...
    def parse_media(self, response, news_tag, media_type):
        ...
        if videoUrl:
            ...
            video_dic = {
                ...
                "name": None,
                "description": None,
                "md5src": self.get_md5_value(videoUrl) + suffix
            }
