...
class UsaUsdaParser(BaseParser):
    name = 'usda'
    
    # 站点id
    site_id = "5f7e6ee3-a7b7-1176-ebe2-5c892d192fa7"
    # 站点名
    site_name = "美国农业部"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "5f7e6ee3-a7b7-1176-ebe2-5c892d192fa7", "source_name": "美国农业部", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("996f93c6-bdd4-3abc-962b-a8b58a4aa405", "媒体", "", "政治"),
            ("4a8f0c7c-fe6f-11ec-a30b-d4619d029786", "媒体/新闻稿", "https://www.usda.gov/media/press-releases?start_date=&page=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//li[@class="news-releases-item"]')
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//article/div/*')
        if news_tags:
