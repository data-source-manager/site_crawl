...
class MnNewsMNParser(BaseParser):
    name = 'newsMn'
    
    # 站点id
    site_id = "54544fd4-8be5-4d29-98a0-2ef8f947256a"
    # 站点名
    site_name = "新闻来源"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "54544fd4-8be5-4d29-98a0-2ef8f947256a", "source_name": "新闻来源", "direction": "mn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("1e3a0701-e6c1-48d2-a876-e45fd7f39172", "世界", "https://news.mn/en/category/world/", "政治"),
            ("abdab608-7209-4d0a-9f7a-f4d4d994f185", "政治", "https://news.mn/en/category/politics/", "政治"),
            ("27e5ce65-1ffb-484a-9f7f-a93f098e5cfb", "社会的", "https://news.mn/en/category/social/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "54544fd4-8be5-4d29-98a0-2ef8f947256a"
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath('//div[@class="author-info"]/h6/text()').extract()
        if authors:
            for au in authors:
                if au.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="image-overlay"]//img|'
                                   '//article//div[contains(@class,"single-content entry-content")]/*')
        if news_tags:
