...
class UsaWeatherParser(BaseParser):
    name = 'weather'
    
    # 站点id
    site_id = "7580062d-51b0-19b1-5061-f5cc601e0463"
    # 站点名
    site_name = "美国国家气象局"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "7580062d-51b0-19b1-5061-f5cc601e0463", "source_name": "美国国家气象局", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f1870-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.weather.gov/news/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="newsst010122"]/p[@class="archive"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//meta[@property="og:title"]/@content|'
                               '//meta[@name="DC.title"]/@content').extract_first(default="")
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//div[@class="topic-tags"]//a/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//figure//img|//div[contains(@id,"paragraph-id")]//div[@class="field__item"]/*|'
                                   '//body/iframe|//div[@class="cms-content"]/*|//div[@class="cms-content"]/p/a/img|'
                                   '//div[@class="cms-content"]/table|//div[@class="cms-content"]/table//img')
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "a", "strong", "em"]:
