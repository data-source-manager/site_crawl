...
class AuInternatIonalaffaIrsParser(BaseParser):
    name = 'internationalaffairs'
    
    # 站点id
    site_id = "fb203c40-69a2-4655-9ddb-0072f3f5e151"
    # 站点名
    site_name = "澳大利亚国际事务研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "fb203c40-69a2-4655-9ddb-0072f3f5e151", "source_name": "澳大利亚国际事务研究所", "direction": "au", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d2952-fe6f-11ec-a30b-d4619d029786", "出版物", "https://www.internationalaffairs.org.au/publications/", "政治"),
            ("4a8d28ee-fe6f-11ec-a30b-d4619d029786", "消息", "https://www.internationalaffairs.org.au/news/page/1/", "政治"),
            ("4a8d29ac-fe6f-11ec-a30b-d4619d029786", "资源", "https://www.internationalaffairs.org.au/resources/", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//div[@class="publish-date"]/strong/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="column"]//p'
                                   '|//div[@class="body-content"]/*'
                                   '|//div[@class="column"]//img') or []
