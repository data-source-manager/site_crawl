...
class USA_spaceforceParser(BaseParser):
    name = 'usa_spaceforce'
    
    # 站点id
    site_id = "fba0248d-171d-46fd-825e-1965062cfe6b"
    # 站点名
    site_name = "美国太空军"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "fba0248d-171d-46fd-825e-1965062cfe6b", "source_name": "美国太空军", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("91233896-2f72-11ed-a768-d4619d029786", "消息", "https://www.spaceforce.mil/News/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath(
            "//h2/a[@class='title']/@href").extract() or []
        print(news_urls)
        if news_urls:
    ...
    def get_tags(self, response) -> list:
        tags = response.xpath("//div[@class='inner']/a/text()").extract()
        if tags:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            "//div[@itemprop='articleBody']/node()|//div[@class='slide']/img|//div[@itemprop='articleBody']/span/node()")
        if news_tags:
            for news_tag in news_tags:
                if isinstance(news_tag.root, str):
                    ...
                    continue
                elif news_tag.root.tag in ["h2", "h3", "h5", "strong", "p"]:
