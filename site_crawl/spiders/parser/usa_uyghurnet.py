...
class UsaUyghUrnetParser(BaseParser):
    name = 'uyghurnet'
    
    # 站点id
    site_id = "f76f7a99-d22d-4439-886f-23cbfce25f29"
    # 站点名
    site_name = "维吾尔裔美国人协会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "f76f7a99-d22d-4439-886f-23cbfce25f29", "source_name": "维吾尔裔美国人协会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d4658-fe6f-11ec-a30b-d4619d029786", "头条新闻", "http://www.uyghurnet.org/kategori/tum-mansetler/", "政治"),
            ("4a8d46c6-fe6f-11ec-a30b-d4619d029786", "维吾尔朋友", "http://www.uyghurnet.org/kategori/uygur-dostlari/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul[@class="konular"]//li/a/@href').extract() or []
    ...
    def get_tags(self, response) -> list:
        tags = response.xpath('//div[@class="category"]/a/text()').extract()
        return [t.strip() for t in tags]

    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@id="storypagemaincol"]/div/*'
                                   '|//div[@id="storypagemaincol"]//img'
                                   '|//div[@class="haber"]/*'
                                   '|//div[@class="haber"]//p'
                                   '|//div[@class="haber"]//img') or []
