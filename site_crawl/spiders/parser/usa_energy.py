...
class UsaEnergyParser(BaseParser):
    name = 'usa_energy'
    # 站点id
    site_id = "ede4ee92-826a-743d-3fe2-8813464c1878"
    # 站点名
    site_name = "美国能源部"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "ede4ee92-826a-743d-3fe2-8813464c1878", "source_name": "美国能源部", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f1802-fe6f-11ec-a30b-d4619d029786", "能源新闻", "https://www.energy.gov/listings/energy-news?page=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h5/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        """
        time_ = response.xpath('//div[@class="page-hero-date"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="field field--text_default field--body"]/div/*')
        if news_tags:
