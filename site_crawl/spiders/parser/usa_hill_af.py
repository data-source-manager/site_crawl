...
class HillafParser(BaseParser):
    name = 'hillaf'
    
    # 站点id
    site_id = "2df7cb96-65db-4dd5-9b0f-0d802ad03b03"
    # 站点名
    site_name = "希尔空军基地"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "2df7cb96-65db-4dd5-9b0f-0d802ad03b03", "source_name": "希尔空军基地", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("912326d0-2f72-11ed-a768-d4619d029786", "消息", "https://www.hill.af.mil/News/a/", "军事"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        # 16.07.2022 – 23:42
        pub = response.xpath('////time/@datetime').extract_first()
        if pub:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section[@class="article-detail-content"]/p')
        if news_tags:
