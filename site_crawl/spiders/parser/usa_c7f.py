...
class UsaC7fParser(BaseParser):
    name = 'c7f'
    
    # 站点id
    site_id = "c9cee7f1-f5f6-4d09-9fe9-e5e07ab7cb14"
    # 站点名
    site_name = "美国第七舰队"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "c9cee7f1-f5f6-4d09-9fe9-e5e07ab7cb14", "source_name": "美国第七舰队", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("31b13035-2140-356f-b123-d1a79780018c", "媒体", "", "政治"),
            ("4a8d9b58-fe6f-11ec-a30b-d4619d029786", "媒体/消息", "https://www.c7f.navy.mil/Media/News/", "政治"),
            ("4a8d9c98-fe6f-11ec-a30b-d4619d029786", "媒体/演讲", "https://www.c7f.navy.mil/media/scheeches/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//span[@class="title"]/a/@href|//p[@class="title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="image"]/img|//div[@class="body"]/*')
        if news_tags:
