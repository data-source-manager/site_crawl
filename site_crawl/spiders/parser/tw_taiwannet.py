...
class TwTaiwanneTParser(BaseParser):
    name = 'taiwannet'
    
    # 站点id
    site_id = "9235d43b-9e0e-4849-9434-6f0ea99cd2ff"
    # 站点名
    site_name = "台湾产经新闻网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9235d43b-9e0e-4849-9434-6f0ea99cd2ff", "source_name": "台湾产经新闻网", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8c98ac-fe6f-11ec-a30b-d4619d029786", "产经商业", "https://news.taiwannet.com.tw/category/c1/Industry_news_page1.html", "政治"),
            ("4a8c980c-fe6f-11ec-a30b-d4619d029786", "大陆港澳", "https://news.taiwannet.com.tw/category/c5/China-Business_news_page1.html", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//div[@class="date"]/span[2]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//figure/img|//div[@class="txt_box"]//img|//div[@class="txt_box"]/node()')
        if news_tags:
    ...
    def get_read_count(self, response) -> int:
        read_count = 0
        read_count_str = response.xpath('//div[@class="date"]/span[3]/text()').get()
        if read_count_str:
