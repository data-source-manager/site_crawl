...
class BoCipCaParser(BaseParser):
    name = 'bo_cipca'
    
    # 站点id
    site_id = "e1416731-cd43-4f2d-af70-d211ab4178b2"
    # 站点名
    site_name = "农民研究与促进中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e1416731-cd43-4f2d-af70-d211ab4178b2", "source_name": "农民研究与促进中心", "direction": "bo", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8ef7c8-fe6f-11ec-a30b-d4619d029786", "消息", "https://cipca.org.bo/noticias/p=1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul[@class="li-noticias-in"]/li/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        """
        time_ = response.xpath('//div[@class="cntInt"]/h4[1]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section[@class="contentInt"]/img|//section[@class="contentInt"]/*')
        if news_tags:
