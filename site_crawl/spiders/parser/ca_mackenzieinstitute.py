...
class CaMackenzieinstituteParser(BaseParser):
    name = 'mackenzieinstitute'
    
    # 站点id
    site_id = "5044e442-f7e0-492b-aa2f-661de23475ad"
    # 站点名
    site_name = "麦肯基研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "5044e442-f7e0-492b-aa2f-661de23475ad", "source_name": "麦肯基研究所", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d73bc-fe6f-11ec-a30b-d4619d029786", "新闻", "https://mackenzieinstitute.com/institute-news/#learnmore", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="entire-meta-link"]/@href').extract() or []
    ...
    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//span[@class="meta-date date updated"]/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="content-inner"]/*'
                                   '|//div[@class="content-inner"]//img') or []
