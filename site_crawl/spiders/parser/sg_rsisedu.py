...
class SgRsiseduParser(BaseParser):
    name = 'rsisedu'
    
    # 站点id
    site_id = "fa437257-1871-40b2-89bd-65e51d73eac0"
    # 站点名
    site_name = "拉勒南国际研究院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "fa437257-1871-40b2-89bd-65e51d73eac0", "source_name": "拉勒南国际研究院", "direction": "sg", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("1429e7ab-c471-3dd5-9d5e-28194d709f30", "媒体", "", "政治"),
            ("4a8d263c-fe6f-11ec-a30b-d4619d029786", "媒体/新闻稿", "https://www.rsis.edu.sg/media-highlights/news-releases/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="media-content-content"]//img|//div[@class="media-content-content"]/*')
        if news_tags:
