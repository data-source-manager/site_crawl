...
class CaThecicParser(BaseParser):
    name = 'thecic'
    
    # 站点id
    site_id = "a06357e6-d19e-4e9d-96f3-90514c523f31"
    # 站点名
    site_name = "加拿大国际事务理事会"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "a06357e6-d19e-4e9d-96f3-90514c523f31", "source_name": "加拿大国际事务理事会", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("406fc468-517f-3d69-2a20-561d6f33ce3d", "专题", "", "政治"),
            ("4a8d736c-fe6f-11ec-a30b-d4619d029786", "专题/加中关系", "https://thecic.org/research/an-assessment-of-50-years-of-canada-china-relations/", "政治"),
            ("4a8d733a-fe6f-11ec-a30b-d4619d029786", "头条新闻", "https://thecic.org/research-publications/behind-the-headlines/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        content = []
        content.append(self.parse_file(response, response.xpath(
            '//a[@class="et_pb_button et_pb_button_0 et_pb_bg_layout_light"]')))
        news_tags = response.xpath('//div[@class="et_pb_text_inner"]/*'
                                   '|//div[@class="et_pb_text_inner"]//img'
                                   '|//div[@class="post-thumbnail header scrolled"]//img'
                                   ) or []
