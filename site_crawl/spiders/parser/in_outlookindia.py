...
class InOutlOOkindiaParser(BaseParser):
    name = 'outlookindia'
    
    # 站点id
    site_id = "eafccc1a-eb26-4969-a8b8-6f452f31906d"
    # 站点名
    site_name = "瞭望网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "eafccc1a-eb26-4969-a8b8-6f452f31906d", "source_name": "瞭望网", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("dd6ec288-665f-3e1e-a71e-ed77c8719093", "杂志", "", "政治"),
            ("4a8d842e-fe6f-11ec-a30b-d4619d029786", "杂志/印度", "https://www.outlookindia.com/national", "政治"),
            ("4a8d82e4-fe6f-11ec-a30b-d4619d029786", "杂志/国际", "https://www.outlookindia.com/international", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h2/a/@href|//h4/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@id="articleBody"]/*'
                                   '|//div[@class="__story_detail "]/figure/img'
                                   '|//div[@class="__gallery_slide"]/div/*'
                                   '|//div[@class="__gallery_slide photoid"]/figure/img') or []
