...
class CaCiiaParser(BaseParser):
    name = 'ciia'
    
    # 站点id
    site_id = "6fcf3314-af8e-ac3f-861d-bcb5a45213b4"
    # 站点名
    site_name = "加拿大国际事务研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "6fcf3314-af8e-ac3f-861d-bcb5a45213b4", "source_name": "加拿大国际事务研究所", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f8fc6-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.ciia.org/category/latest-news/page/1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//main[@id="main"]//h2/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content"]/*'
                                   '|//div[@class="entry-content"]//img') or []
