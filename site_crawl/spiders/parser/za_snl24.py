...
class ZaSnl24Parser(BaseParser):
    name = 'snl24'
    
    # 站点id
    site_id = "a0ecbad5-9783-863e-2926-372cdf74b443"
    # 站点名
    site_name = "每日太阳报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "a0ecbad5-9783-863e-2926-372cdf74b443", "source_name": "每日太阳报", "direction": "za", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f7e82-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.snl24.com/dailysun/News", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="article-item--url "]/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//meta[@name="publisheddate"]/@content').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[contains(@class,"article__featured-image")]/img|'
