...
class VeCediCeParser(BaseParser):
    name = 'cedice'
    
    # 站点id
    site_id = "196efbbd-ccd0-4390-8086-00dbf7c37157"
    # 站点名
    site_name = "自由经济知识传播中心"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "196efbbd-ccd0-4390-8086-00dbf7c37157", "source_name": "自由经济知识传播中心", "direction": "ve", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("6e84967c-35ec-490a-a095-edf42d04a19c", "新闻", "https://cedice.org.ve/category/nota-de-prensa/", "政治"),
        ]
    ]
