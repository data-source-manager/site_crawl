...
class CnEastdayParser(BaseParser):
    name = 'eastday'

    # 站点id
    site_id = "e83c292b-20f4-4ffc-8e23-f6d1870840d0"
    # 站点名
    site_name = "东方网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e83c292b-20f4-4ffc-8e23-f6d1870840d0", "source_name": "东方网", "direction": "cn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块主题)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8df378-fe6f-11ec-a30b-d4619d029786", "中国", "http://english.eastday.com/China/index.html", "政治"),
            ("4a8df3d2-fe6f-11ec-a30b-d4619d029786", "世界", "http://english.eastday.com/World/index.html", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul[@class="list5"]/li/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="greyb20 lh28"]/*|//div[@class="greyb20 lh28"]/p/img')
        if news_tags:
