...
class UsaNsfParser(BaseParser):
    name = 'nsf'
    
    # 站点id
    site_id = "2bddb205-844d-5737-43d9-3c0938ce5187"
    # 站点名
    site_name = "美国国家科学基金会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "2bddb205-844d-5737-43d9-3c0938ce5187", "source_name": "美国国家科学基金会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d4478-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.nsf.gov/news/", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//div[@class="field__content"]/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="clearfix text-formatted field field-news-body"]/*'
                                   '|//div[@class="clearfix text-formatted field field-news-body"]//img'
                                   '|//div[@class="image-container"]//img') or []
