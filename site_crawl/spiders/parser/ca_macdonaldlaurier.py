...
class CaMacdonaldlaurierParser(BaseParser):
    name = 'macdonaldlaurier'
    
    # 站点id
    site_id = "a8ec09f0-ea15-4f23-b9cd-21016c06d9a6"
    # 站点名
    site_name = "麦克唐纳-洛里埃研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "a8ec09f0-ea15-4f23-b9cd-21016c06d9a6", "source_name": "麦克唐纳-洛里埃研究所", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d742a-fe6f-11ec-a30b-d4619d029786", "最新消息", "https://www.macdonaldlaurier.ca/category/blog-posts/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath(
            '//article[@class="jeg_post jeg_pl_md_1 format-standard"]//h3/a/@href').extract() or []
