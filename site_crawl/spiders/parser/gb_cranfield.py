...
class GbCranfieldParser(BaseParser):
    name = 'cranfield'
    
    # 站点id
    site_id = "7b05f959-690e-039e-af15-a8d0930d4267"
    # 站点名
    site_name = "克兰菲尔德水科学研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "7b05f959-690e-039e-af15-a8d0930d4267", "source_name": "克兰菲尔德水科学研究所", "direction": "gb", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d92d4-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.cranfield.ac.uk/press", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="text-container"]/h3/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//meta[@name="article-date"]/@content').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="no-caption"]/img|//div[@class="tc tc1 sc-richtext-container"]/*|'
                                   '//div[@class="tc tc1 sc-richtext-container"]/p/a')
        if news_tags:
