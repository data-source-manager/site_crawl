...
class EsCieplanParser(BaseParser):
    name = 'cieplan'
    
    # 站点id
    site_id = "f600af9d-c708-4e1e-9ccd-170cda0e50bc"
    # 站点名
    site_name = "拉丁美洲研究公司"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "f600af9d-c708-4e1e-9ccd-170cda0e50bc", "source_name": "拉丁美洲研究公司", "direction": "es", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d8be0-fe6f-11ec-a30b-d4619d029786", "新闻发布室", "https://www.cieplan.org/category/sala-de-prensa/", "政治"),
            ("4a8d8c44-fe6f-11ec-a30b-d4619d029786", "采访", "https://www.cieplan.org/category/sala-de-prensa/cieplan-en-la-prensa/entrevistas/", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        print('-----------' * 6)
        try:
            _time = response.xpath('//li[@itemprop="datePublished"]/a/@href').extract_first()
            print(_time)
            _time = re.search(r'(\d+/\d+/\d+)', _time).groups()[0]
            y, m, d = _time.split("/")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//div[@class="elementor-element elementor-element-b127697 elementor-widget elementor-widget-theme-post-content"]/div/*'
            '|//div[@class="elementor-element elementor-element-b127697 elementor-widget elementor-widget-theme-post-content"]/div//img') or []
