...
class UsarParser(BaseParser):
    name = 'usar'
    # 站点id
    site_id = "3b18508a-efcd-450a-8c7a-c266d65d6266"
    # 站点名
    site_name = "美国陆军预备役"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "3b18508a-efcd-450a-8c7a-c266d65d6266", "source_name": "美国陆军预备役", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("9123397c-2f72-11ed-a768-d4619d029786", "消息", "https://www.usar.army.mil/News/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        urls = response.xpath('//div[@class="item row"]//span[@class="title"]/a/@href').extract()
        if urls:
            for url in urls:
