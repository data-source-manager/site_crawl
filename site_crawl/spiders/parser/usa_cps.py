...
class UsaCpsParser(BaseParser):
    name = 'usa_cps'
    
    # 站点id
    site_id = "79c08e6e-f271-44f1-b64b-a3a29d3a5b71"
    # 站点名
    site_name = "政策研究中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "79c08e6e-f271-44f1-b64b-a3a29d3a5b71", "source_name": "政策研究中心", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f1ff0-fe6f-11ec-a30b-d4619d029786", "新闻", "https://cps.ceu.edu/news?tid_1=&page=0", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath(
            '//div[@class="col-md-8 radix-layouts-content panel-panel"]/div/div[1]/div/text()').extract_first()
        if time_:
