...
class InLiParser(BaseParser):
    name = 'li'
    
    # 站点id
    site_id = "de2312a5-ea26-5cd2-c67f-c0bc239209a4"
    # 站点名
    site_name = "勒加图姆研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "de2312a5-ea26-5cd2-c67f-c0bc239209a4", "source_name": "勒加图姆研究所", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f86de-fe6f-11ec-a30b-d4619d029786", "新闻", "https://li.com/newsfeed/page/1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="news-listing sss"]//h2/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//div[@class="content-block report"]//p/a/text()').extract()[-2:]
        return authors
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="content"]//p|//figure[@class="wp-caption aligncenter"]/img') or []
