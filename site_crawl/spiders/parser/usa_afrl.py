...
class UsaAfRlParser(BaseParser):
    name = 'usa_afrl'
    
    # 站点id
    site_id = "7b727dd5-b1ff-42fa-a47a-20d929e48428"
    # 站点名
    site_name = "美国空军研究院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "7b727dd5-b1ff-42fa-a47a-20d929e48428", "source_name": "美国空军研究院", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8e2f32-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.afrl.af.mil/News/", "政治"),
        ]
    ]
