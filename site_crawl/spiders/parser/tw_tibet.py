...
class TwTibeTParser(BaseParser):
    name = 'tibet'
    
    # 站点id
    site_id = "e48d3e50-c5a8-489c-bb19-eccfa37282a1"
    # 站点名
    site_name = "达赖喇嘛宗教基金"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e48d3e50-c5a8-489c-bb19-eccfa37282a1", "source_name": "达赖喇嘛宗教基金", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("fe4727e1-2444-3b66-a145-2ea1e85169af", "关于西藏", "", "政治"),
            ("8b20eb34-1f4e-312d-b97a-c0d223899117", "关于西藏/流亡政府", "http://www.tibet.org.tw/news_item.php?type=G", "政治"),
            ("2ead447b-8e20-788b-dadf-d771972515fd", "最新消息", "", "政治"),
            ("f557bb71-6cdd-4171-9a7e-be06e98fdb42", "最新消息/新闻集锦", "http://www.tibet.org.tw/news_item.php?type=N", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "e48d3e50-c5a8-489c-bb19-eccfa37282a1"
        self.Dict = {}

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//tbody/tr')
        if news_urls:
            for news_url in news_urls:
                rsp_url = news_url.xpath('./td/a/@href').get()
                rsp_time = news_url.xpath('./td[1]/text()').get()
                rsp_title = news_url.xpath('./td/a/h4/text()').get()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//span[@class="daword"]/img|//div[@class="col-md-8"]//img|'
                                   '//div[@class="col-md-8"]/p|//div[@class="panel-body"]/p')
        if news_tags:
