...
class UsaAsiAsocietyParser(BaseParser):
    name = 'asiasociety'
    # 站点id
    site_id = "3751bcde-e284-6c21-8241-b645f1745c8c"
    # 站点名
    site_name = "亚洲协会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "3751bcde-e284-6c21-8241-b645f1745c8c", "source_name": "亚洲协会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("91ea9a7d-ebfe-4a7b-b5fb-7de24752fba9", "新闻", "https://asiasociety.org/japan/news?page=0", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//ul[@class="slick-dots"]//img'
                                   '|//div[@property="schema:text"]/*'
                                   '|//div[@property="schema:text"]//img') or []
