...
class TwElandParser(BaseParser):
    name = 'e-land'
    
    # 站点id
    site_id = "9ab799a0-03e4-42f8-8dcd-f14c106e215c"
    # 站点名
    site_name = "宜兰县政府全球资讯网中文版"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "9ab799a0-03e4-42f8-8dcd-f14c106e215c", "source_name": "宜兰县政府全球资讯网中文版", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("d11c4763-880e-44fc-8bab-a079899b0342", "财政新闻", "https://www.e-land.gov.tw/News.aspx?n=770C4B84956BD13B", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//table[@class="css_tr"]//td/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="data_midlle_news_box02"]/*|'
                                   '//div[@class="news_box03_img"]/ol/li//img')
        if news_tags:
