...
class UsaAfParser(BaseParser):
    name = 'usa_af'
    
    # 站点id
    site_id = "a855e27a-82dd-4e1b-a2e3-62aa9f328391"
    # 站点名
    site_name = "美国空军官方网站"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "a855e27a-82dd-4e1b-a2e3-62aa9f328391", "source_name": "美国空军官方网站", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f04ca-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.af.mil/News/Category/22750/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section[@class="article-detail-content"]/*|//video[@class="dvidsPlayer"]|'
                                   '//picture[@class="inline-media default"]/img')
        if news_tags:
