...
class UsaDinGovParser(BaseParser):
    name = 'usa_dnigov'
    
    # 站点id
    site_id = "af5c417f-cdb4-7f35-137b-5f1dd97f0d24"
    # 站点名
    site_name = "国家情报总监办公室"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "af5c417f-cdb4-7f35-137b-5f1dd97f0d24", "source_name": "国家情报总监办公室", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f0740-fe6f-11ec-a30b-d4619d029786", "ODNI 新闻室", "https://www.dni.gov/index.php/newsroom/press-releases?start=0", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//div[@class="itemFullText"]/h4/text()').extract_first(default="")
    ...
    def get_pub_time(self, response) -> str:
        ...
        """
        times_ = response.xpath('//span[@class="itemDateCreated"]/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="itemFullText"]/p')
        if news_tags:
