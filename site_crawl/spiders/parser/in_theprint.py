...
class InTheprinTParser(BaseParser):
    name = 'theprint'
    
    # 站点id
    site_id = "8a9ca8c0-9be3-4c4c-b7a2-672896dd4166"
    # 站点名
    site_name = "印度印刷报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8a9ca8c0-9be3-4c4c-b7a2-672896dd4166", "source_name": "印度印刷报", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d8abe-fe6f-11ec-a30b-d4619d029786", "印度", "https://theprint.in/category/india/", "政治"),
            ("4a8d8a50-fe6f-11ec-a30b-d4619d029786", "政治", "https://theprint.in/category/politics/", "政治"),
            ("4a8d8af0-fe6f-11ec-a30b-d4619d029786", "观点", "https://theprint.in/category/opinion/", "政治"),
            ("4a8d8a8c-fe6f-11ec-a30b-d4619d029786", "防御", "https://theprint.in/category/defence/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="td-module-meta-info"]/h3/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="tdb-block-inner td-fix-index"]/*'
                                   '|//div[@class="tdb-block-inner td-fix-index"]/figure/img') or []
    ...
    def parse_single_img(self, response, news_tag):
        ...
        img_src = news_tag.xpath("./@data-gmsrc").extract_first()
