...
class MnGandanParser(BaseParser):
    name = 'gandan'
    channel = [
        {'url': 'https://gandan.mn/index.php/news', 'direction': 'mn', 'source_name': '蒙古佛教中心甘丹特克亨林寺',
         'site_board_name': '新闻资讯', 'board_theme': '政治', 'if_front_position': False,
         'board_id': 'ff10498e-b323-4c9f-a929-f0b5200d4b22'},
        {'url': 'https://gandan.mn/index.php/bogduud', 'direction': 'mn', 'source_name': '蒙古佛教中心甘丹特克亨林寺',
         'site_board_name': '所有的上级', 'board_theme': '政治', 'if_front_position': False,
         'board_id': 'c39a80b7-3570-4abd-b3e5-e41071331cb6'}
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h3[@class="event-title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//figure/img|//div[@class="causes-caption"]/p/text()')
        if news_tags:
