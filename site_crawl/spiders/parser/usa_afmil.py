...
class UsaAfMilParser(BaseParser):
    name = 'usa_afmil'
    ...
    channel = [
        ...
        for board_id, board_name, board_url, board_theme in [
            ("4a8f04ca-fe6f-11ec-a30b-d4619d029786", "新闻", "http://www.af.mil/News/Category/22750/?Page=1", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section[@class="article-detail-content"]/*|'
