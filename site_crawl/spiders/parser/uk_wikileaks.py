...
class UkWikiLeaksParser(BaseParser):
    name = 'uk_wikileaks'
    
    # 站点id
    site_id = "1af24ac5-9196-df2c-9ec7-71d59f1f80d1"
    # 站点名
    site_name = "维基解密"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "1af24ac5-9196-df2c-9ec7-71d59f1f80d1", "source_name": "维基解密", "direction": "uk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f25f4-fe6f-11ec-a30b-d4619d029786", "新闻", "https://wikileaks.org/-News-.html", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        ...
        """
        time_ = response.xpath('//div[@class="timestamp"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//center/img|//div[@class="text-content"]/*')
        if news_tags:
