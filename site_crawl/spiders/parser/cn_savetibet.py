...
class CnSavetibetParser(BaseParser):
    name = 'savetibet'
    
    # 站点id
    site_id = "54c2bd71-30d1-bfe1-74dd-1efeaf8e9550"
    # 站点名
    site_name = "国际声援西藏运动"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "54c2bd71-30d1-bfe1-74dd-1efeaf8e9550", "source_name": "国际声援西藏运动", "direction": "cn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f928c-fe6f-11ec-a30b-d4619d029786", "新闻", "https://savetibet.org/latest-news/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="post-content"]//h2/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="fusion-text fusion-text-1"]/*'
                                   '|//div[@class="fusion-text fusion-text-1"]/img'
                                   '|//div[@class="post-content"]/*'
                                   '|//div[@class="post-content"]//img') or []
