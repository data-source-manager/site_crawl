...
class TwCnkmgroupParser(BaseParser):
    name = 'cnkmgroup'
    # 站点id
    site_id = "14c22798-0121-46d5-8e03-b4c869b70123"
    # 站点名
    site_name = "中华新知传媒"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "14c22798-0121-46d5-8e03-b4c869b70123", "source_name": "中华新知传媒", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("40633d6c-a073-11ed-9f91-1094bbebe6dc", "两岸观", "http://cnkmgroup.com/category/ats/", "政治"),
        ]
    ]

    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "14c22798-0121-46d5-8e03-b4c869b70123"

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@id="aft-inner-row"]//h3/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div/img|//figure/img|//div[@class="entry-content"]/*')
        if news_tags:
