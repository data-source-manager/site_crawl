...
class UsaMiSawaParser(BaseParser):
    name = 'usa_misawa'
    
    # 站点id
    site_id = "69c3d251-89b1-461e-afb6-bfd586bd5e45"
    # 站点名
    site_name = "三泽空军基地"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "69c3d251-89b1-461e-afb6-bfd586bd5e45", "source_name": "三泽空军基地", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("b7a27673-ab76-3903-8b45-4ae329e40fa3", "消息", "https://www.misawa.af.mil/News/", "政治"),
            ("4a8e2028-fe6f-11ec-a30b-d4619d029786", "消息/评论", "https://www.misawa.af.mil/News/Commentaries/", "政治"),
            ("074e6db1-f1a1-444e-98d6-beaed9006501", "航行通告", "https://www.misawa.af.mil/NOTAMs/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id='69c3d251-89b1-461e-afb6-bfd586bd5e45'
        self.Dict = {}

    def parse_list(self, response) -> list:
        if "NOTAMs" in response.url:
            news_urls = response.xpath('//div[@class="livehtml"]/p/a')
            if news_urls:
    ...
    def get_tags(self, response) -> list:
        ...
        if ".pdf" in response.url:
            ...
            tags = response.xpath('//footer/a/text()').extract()
            if tags:
                for tag in tags:
                    if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        if ".pdf" in response.url:
            ...
            news_tags = response.xpath('//section/*|//section|//picture/img')
            if news_tags:
                for news_tag in news_tags:
                    if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "strong", "section"]:
