...
class TheatlanticParser(BaseParser):
    name = 'theatlantic'
    
    # 站点id
    site_id = "9c5c76fb-fc93-4c80-9e99-9ebd7a4f5610"
    # 站点名
    site_name = "大西洋月刊"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9c5c76fb-fc93-4c80-9e99-9ebd7a4f5610", "source_name": "大西洋月刊", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("e700f75e-7607-11ed-ad4d-d4619d029786", "想法", "https://www.theatlantic.com/politics/", "政治"),
            ("e700df8a-7607-11ed-ad4d-d4619d029786", "政治", "https://www.theatlantic.com/politics/", "政治"),
        ]
    ]
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//address[@id="byline"]/a/text()').extract()
        if authors:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//section[contains(@class, "ArticleBody")]/p|'
            '////section[contains(@class, "ArticleBody")]/div/figure/picture/img')
        if news_tags:
