...
class UsaPhilstarParser(BaseParser):
    name = 'philstar'
    
    # 站点id
    site_id = "e6e6c6bb-ab3d-4a39-bea1-f603b8969486"
    # 站点名
    site_name = "菲律宾星报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e6e6c6bb-ab3d-4a39-bea1-f603b8969486", "source_name": "菲律宾星报", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f786a-fe6f-11ec-a30b-d4619d029786", "世界", "https://www.philstar.com/world", "政治"),
            ("4a8f781a-fe6f-11ec-a30b-d4619d029786", "商业", "https://www.philstar.com/business", "政治"),
            ("f52e64a7-3a43-a189-620d-f68e4050bba6", "国际", "https://www.philstar.com/nation", "政治"),
            ("4a8f77ca-fe6f-11ec-a30b-d4619d029786", "观点", "https://www.philstar.com/opinion", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('').extract() or ""
        if news_urls:
            for news_url in list(set(news_urls)):
                yield urljoin(response.url, news_url)

    def get_title(self, response) -> str:
        title = response.xpath('').extract_first(default="")
        return title.strip() if title else ""

    def get_author(self, response) -> list:
        author_list = []

        authors = response.xpath('').extract()
        if authors:
            for au in authors:
                if au.strip():
