...
class MxCideParser(BaseParser):
    name = 'cide'
    
    # 站点id
    site_id = "fba41932-2203-4a00-a40d-29952283ff9e"
    # 站点名
    site_name = "经济研究与教育中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "fba41932-2203-4a00-a40d-29952283ff9e", "source_name": "经济研究与教育中心", "direction": "mx", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f2a72-fe6f-11ec-a30b-d4619d029786", "新闻发布室", "https://www.cide.edu/noticias/sala-de-prensa/page/1", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//div[@class="title_space"]/text()').extract_first(default="")
    ...
    def get_pub_time(self, response) -> str:
        ...
        times_ = response.xpath('//div[@class="info_space"]/text()').extract_first()
        month, day, year = re.findall(', (.*). (\d{1,2}), (\d{4})', times_)[0]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="col l9 m11 s12"]//img|//div[@class="content"]/*')
        if news_tags:
