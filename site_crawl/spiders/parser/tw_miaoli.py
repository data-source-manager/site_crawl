...
class TwMiaoliParser(BaseParser):
    name = 'miaoli'
    
    # 站点id
    site_id = "728be667-eb76-405b-9c86-c5969abeb40a"
    # 站点名
    site_name = "苗栗县政府"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "728be667-eb76-405b-9c86-c5969abeb40a", "source_name": "苗栗县政府", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("e7010078-7607-11ed-ad4d-d4619d029786", "县府新闻", "https://www.miaoli.gov.tw/News.aspx?n=285&sms=9462", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//td[contains(@class,"jGridView")]//a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[contains(@class,"around-pic")]/*|'
                                   '//div[@class="p"]//img')
        if news_tags:
