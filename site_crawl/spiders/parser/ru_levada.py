...
class RuLevadaParser(BaseParser):
    name = 'levada'
    
    # 站点id
    site_id = "cf8d8f8d-a76d-409f-8519-c1290b33f242"
    # 站点名
    site_name = "列瓦达民调中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "cf8d8f8d-a76d-409f-8519-c1290b33f242", "source_name": "列瓦达民调中心", "direction": "ru", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d1df4-fe6f-11ec-a30b-d4619d029786", "新闻稿", "https://www.levada.ru/en/category/publications/press-releases/page/1/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content"]/*|//div[@class="entry-content"]/figure//img')
        if news_tags:
