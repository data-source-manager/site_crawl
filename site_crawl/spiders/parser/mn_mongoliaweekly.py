...
class MnMongoliaweeklyParser(BaseParser):
    name = 'mongoliaweekly'
    # 站点id
    site_id = "e577f203-63f9-4893-b553-ecee18e9bc82"
    # 站点名
    site_name = "蒙古周刊"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e577f203-63f9-4893-b553-ecee18e9bc82", "source_name": "蒙古周刊", "direction": "mn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("None", "外交", "https://www.mongoliaweekly.org/home/categories/diplomacy", "政治"),
            ("None", "政治", "https://www.mongoliaweekly.org/home/categories/politics", "政治"),
            ("None", "独家", "https://www.mongoliaweekly.org/home/categories/exclusives", "政治"),
        ]
    ]

    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = 'e577f203-63f9-4893-b553-ecee18e9bc82'

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[contains(@class,"has-custom-focus")]/@href').extract() or ""
        if news_urls:
