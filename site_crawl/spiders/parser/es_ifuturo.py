...
class EsIfuturoParser(BaseParser):
    name = 'ifuturo'
    
    # 站点id
    site_id = "57dff0c0-b773-4496-bc0b-39ffd7ec66d2"
    # 站点名
    site_name = "未来研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "57dff0c0-b773-4496-bc0b-39ffd7ec66d2", "source_name": "未来研究所", "direction": "es", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d8b90-fe6f-11ec-a30b-d4619d029786", "会议", "https://ifuturo.org/conferencias-2/", "政治"),
            ("4a8d8b5e-fe6f-11ec-a30b-d4619d029786", "报告", "https://ifuturo.org/informes/", "政治"),
        ]
    ]
