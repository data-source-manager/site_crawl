...
class TwAirMndParser(BaseParser):
    name = 'mnd'
    
    # 站点id
    site_id = "63045bf1-15c3-4db9-bb81-8ef73492c7c3"
    # 站点名
    site_name = "中华民国空军"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "63045bf1-15c3-4db9-bb81-8ef73492c7c3", "source_name": "中华民国空军", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("de050501-b4a8-4bcc-b6fc-5e34109ad29d", "最新消息", "https://air.mnd.gov.tw/TW/News/News_List.aspx?CID=48", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul[contains(@id,"ul_List")]/li/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//span[contains(@id,"Content")]/*')
        if news_tags:
