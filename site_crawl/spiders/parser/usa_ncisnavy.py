...
class NcisnavyParser(BaseParser):
    name = 'ncisnavy'
    # 站点id
    site_id = "5e5c6f26-f262-4d4b-bf0f-66c0a27f5a42"
    # 站点名
    site_name = "美国海军犯罪调查局"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "5e5c6f26-f262-4d4b-bf0f-66c0a27f5a42", "source_name": "美国海军犯罪调查局", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("984c0799-b7d1-36d9-b16e-96662851c94d", "媒体", "", "政治"),
            ("91232c20-2f72-11ed-a768-d4619d029786", "媒体/新闻", "https://www.ncis.navy.mil/Media/Press-Releases/", "军事"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//h1[@id="node-title"]/text()|//h1[@class="node-title"]/text()').extract_first(
            default="")
    ...
    def get_pub_time(self, response) -> str:
        # 16.07.2022 – 23:42
        pub = response.xpath('//span[@datatype="xsd:dateTime"]/@content').extract_first()
        if pub:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//h1[@id="node-title"]/following-sibling::div/div/div/p|'
            '//h1[@class="node-title"]/following-sibling::div/div/div/p')
        if news_tags:
