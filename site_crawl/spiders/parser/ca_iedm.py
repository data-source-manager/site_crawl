...
class CaIedmParser(BaseParser):
    name = 'iedm'
    
    # 站点id
    site_id = "292f33d8-8f06-48f1-9333-2996747225ba"
    # 站点名
    site_name = "蒙特利尔经济研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "292f33d8-8f06-48f1-9333-2996747225ba", "source_name": "蒙特利尔经济研究所", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d7308-fe6f-11ec-a30b-d4619d029786", "媒体发布", "https://www.iedm.org/category/content-types/content-media-releases/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//header/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content"]/*'
                                   '|//div[@class="post-thumbnail-ctn"]//img') or []
