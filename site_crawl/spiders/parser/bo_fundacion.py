...
class BoFundaCionParser(BaseParser):
    name = 'bo_fundacion'
    
    # 站点id
    site_id = "dd8537bc-2f8c-4924-a499-dbd27f18d305"
    # 站点名
    site_name = "千禧基金会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "dd8537bc-2f8c-4924-a499-dbd27f18d305", "source_name": "千禧基金会", "direction": "bo", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8ef6f6-fe6f-11ec-a30b-d4619d029786", "新闻", "https://fundacion-milenio.org/fundacion-milenio-en-la-prensa/page/1/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@data-id="3073f77"]/div/*')
        if news_tags:
