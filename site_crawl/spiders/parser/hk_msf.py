...
class HkMsfParser(BaseParser):
    name = 'msf'
    
    # 站点id
    site_id = "c154297c-1273-b7f7-f448-074051264fe4"
    # 站点名
    site_name = "无国界"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "c154297c-1273-b7f7-f448-074051264fe4", "source_name": "无国界", "direction": "hk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("7e6bb9a5-aab8-4965-b06b-50f564439b40", "新闻", "https://msf.hk/zh-hant/news?page=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="field-item even"]/h2/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="featured_section full_width"]//img'
