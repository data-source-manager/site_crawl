...
class UkCentreforprogressiveCapitalismParser(BaseParser):
    name = 'centreforprogressivecapitalism'
    
    # 站点id
    site_id = "05a72334-8878-9e09-70a1-227f9dd3c005"
    # 站点名
    site_name = "进步资本主义中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "05a72334-8878-9e09-70a1-227f9dd3c005", "source_name": "进步资本主义中心", "direction": "uk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f88b4-fe6f-11ec-a30b-d4619d029786", "档案中心", "https://centreforprogressivecapitalism-archive.net/page/1", "政治"),
        ]
    ]
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//span[@class="author vcard"]//a[2]/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="post-thumbnail"]//img|//div[@class="entry-content"]//p') or []
