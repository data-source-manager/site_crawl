...
class Usa_afneuropeParser(BaseParser):
    name = 'usa_afneurope'
    
    # 站点id
    site_id = "14a300a7-0dc7-406f-a228-51b7f77a4589"
    # 站点名
    site_name = "欧洲美军网络"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "14a300a7-0dc7-406f-a228-51b7f77a4589", "source_name": "欧洲美军网络", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("91231ef6-2f72-11ed-a768-d4619d029786", "新闻广播", "https://www.afneurope.net/Newscast/", "政治"),
        ]
    ]
