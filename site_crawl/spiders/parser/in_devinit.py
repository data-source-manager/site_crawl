...
class InDevinitParser(BaseParser):
    name = 'devinit'
    
    # 站点id
    site_id = "245c7e24-0c81-ebdf-fe6b-80d978ba1401"
    # 站点名
    site_name = "发展倡议"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "245c7e24-0c81-ebdf-fe6b-80d978ba1401", "source_name": "发展倡议", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f8846-fe6f-11ec-a30b-d4619d029786", "资源", "https://devinit.org/resources/?page=1&nav=header", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="l-2up-3up"]//a/@href').extract() or []
    ...
    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//li[@class="hero__meta-item"]/text()').extract_first()
            d, m, y = _time.strip("\n").strip().split(" ")
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="is-typeset wysiwyg is-typeset--additionals"]/*'
                                   '|//div[@class="is-typeset wysiwyg is-typeset--additionals"]//img'
                                   '|//main[@id="pagecontent"]//p') or []
