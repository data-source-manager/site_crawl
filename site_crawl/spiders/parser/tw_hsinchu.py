...
class TwHsincHuParser(BaseParser):
    name = 'hsinchu'
    
    # 站点id
    site_id = "c2c15c3f-8709-4893-833f-3fafdf84606e"
    # 站点名
    site_name = "新竹县政府全球资讯网"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "c2c15c3f-8709-4893-833f-3fafdf84606e", "source_name": "新竹县政府全球资讯网", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("e700a81c-7607-11ed-ad4d-d4619d029786", "县府新闻", "https://www.hsinchu.gov.tw/News.aspx?n=153&sms=8603&page=1&PageSize=20", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//td[@class="CCMS_jGridView_td_Class_1"]/span/a/@href').extract() or ""
        if news_urls:
    ...
    def get_title(self, response) -> str:
        ...
        return title.strip().replace('\xa0', '').replace('\u3000', '') if title else ""
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="p"]//img|//div[@class="p"]/*|//div[@class="p"]/p/a')
        if news_tags:
