...
class TwMoiParser(BaseParser):
    name = 'moi'
    
    # 站点id
    site_id = "e4202c2c-28a1-4f6e-b0a3-6c2f6da41ab3"
    # 站点名
    site_name = "中华民国内政部全球咨询网"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "e4202c2c-28a1-4f6e-b0a3-6c2f6da41ab3", "source_name": "中华民国内政部全球咨询网", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("23ba6eac-e8db-4d87-a968-edbb4fc21018", "国内", "https://www.moi.gov.tw/News.aspx?n=8&sms=9224", "政治"),
            ("6dea9603-2caa-4903-8d18-1145f456a45d", "新闻发布", "https://www.moi.gov.tw/News.aspx?n=4&sms=9009&_CSN=1588", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        ...
        """
        time_ = response.xpath('//div[@class="list-text detail"]//ul/li/span/text()').extract_first()
        if time_:
            time_ = time_.replace("發布日期：", "")
