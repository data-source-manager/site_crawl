...
class CaCanada2020Parser(BaseParser):
    name = 'canada2020'
    
    # 站点id
    site_id = "e958d0a2-7892-4608-a416-5eb62e9bf4ec"
    # 站点名
    site_name = "加拿大2020"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e958d0a2-7892-4608-a416-5eb62e9bf4ec", "source_name": "加拿大2020", "direction": "ca", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f3a1c-fe6f-11ec-a30b-d4619d029786", "新闻", "https://canada2020.ca/news/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div/a[@class="list-single-link"]/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content"]/*|//div[@class="entry-content"]/figure/a/img')
        if news_tags:
