...
class LtLLriParser(BaseParser):
    name = 'llri'
    
    # 站点id
    site_id = "5317f699-e688-47a1-82eb-e0637e3fbb14"
    # 站点名
    site_name = "立陶宛自由市场研究所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "5317f699-e688-47a1-82eb-e0637e3fbb14", "source_name": "立陶宛自由市场研究所", "direction": "lt", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8cf0fe-fe6f-11ec-a30b-d4619d029786", "新闻稿", "https://en.llri.lt/tipai/press-releases/page/1", "政治"),
        ]
    ]
