...
class UkFpcParser(BaseParser):
    name = 'fpc'
    
    # 站点id
    site_id = "9866abd5-0ec5-eb36-4b83-e397b95d2acf"
    # 站点名
    site_name = "外交政策中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9866abd5-0ec5-eb36-4b83-e397b95d2acf", "source_name": "外交政策中心", "direction": "uk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f85f8-fe6f-11ec-a30b-d4619d029786", "文章", "https://fpc.org.uk/articles/page/1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@id="main-content"]//h2/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        return response.xpath('//meta[@name="author"]/@content').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="grid-12 single-article-image"]//img'
                                   '|//div[@class="grid-12 article-push entry-content"]//p') or []
