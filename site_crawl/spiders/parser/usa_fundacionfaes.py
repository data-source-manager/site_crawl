...
class UsaFundacionFaesParser(BaseParser):
    name = 'fundacionfaes'
    
    # 站点id
    site_id = "e07f190b-d8af-478a-8267-be416791eb0e"
    # 站点名
    site_name = "社会分析与研究基金会"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "e07f190b-d8af-478a-8267-be416791eb0e", "source_name": "社会分析与研究基金会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d2c04-fe6f-11ec-a30b-d4619d029786", "分析", "https://fundacionfaes.org/analisis-de-faes/", "政治"),
            ("4a8d2b96-fe6f-11ec-a30b-d4619d029786", "新闻和多媒体", "https://fundacionfaes.org/prensa-y-multimedia/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="elementor-widget-container"]//article//h1/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath(
            '//span[@class="elementor-icon-list-text elementor-post-info__item elementor-post-info__item--type-custom"]/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="elementor-widget-container"]//p'
                                   '|//div[@class="field-items"]//*') or []
