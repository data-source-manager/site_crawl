...
class LaKplParser(BaseParser):
    name = 'kpl'
    
    # 站点id
    site_id = "c990da42-74e8-49f9-941f-ab7b966dd2ce"
    # 站点名
    site_name = "巴特寮通讯社"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "c990da42-74e8-49f9-941f-ab7b966dd2ce", "source_name": "巴特寮通讯社", "direction": "la", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f58d0-fe6f-11ec-a30b-d4619d029786", "政治", "https://kpl.gov.la/News.aspx?cat=1", "政治"),
            ("a0982845-a9af-41e5-819e-9d9959fe53c5", "经济", "https://kpl.gov.la/News.aspx?cat=3", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath(
            '//article[@class="content-main"]/section//a[contains(@href,"detail")]/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//span[contains(@class,"post-time ")]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="post-ct-entry"]/*|'
