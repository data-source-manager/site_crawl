...
class UkSuSSexParser(BaseParser):
    name = 'sussex'
    
    # 站点id
    site_id = "79b5cc1f-9349-a45c-b758-803b4e2db1fa"
    # 站点名
    site_name = "科学政策研究部"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "79b5cc1f-9349-a45c-b758-803b4e2db1fa", "source_name": "科学政策研究部", "direction": "uk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f8a80-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.sussex.ac.uk/news/all?page=1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@id="news"]//a/@href').extract() or []
    ...
    def get_pub_time(self, response) -> str:
        _time = response.xpath('//meta[@name="date"]/@content').extract_first()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="news-assets"]//img'
                                   '|//div[@id="news-item"]/*'
                                   '|//div[@class="x_x_x_x_WordSection1"]/*') or []
