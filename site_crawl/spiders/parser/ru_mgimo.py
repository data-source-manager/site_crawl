...
class RuMgiMoParser(BaseParser):
    name = 'mgimo'
    
    # 站点id
    site_id = "33efe668-e9cc-40a8-a43f-db8c93cd4921"
    # 站点名
    site_name = "莫斯科国立国际关系学院"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "33efe668-e9cc-40a8-a43f-db8c93cd4921", "source_name": "莫斯科国立国际关系学院", "direction": "ru", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d1534-fe6f-11ec-a30b-d4619d029786", "新闻", "https://english.mgimo.ru/news?Elements_page=1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="news-img"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="col col-12"]//img|//div[@class="col col-12"]/*')
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "a", "strong", "sup"]:
