...
class InBhaskarParser(BaseParser):
    name = 'bhaskar'
    ...
    channel = [
        {
            ...
            **{"site_id": "b6914aa2-aa34-4749-b37d-ed5fa4bd6bdc", "source_name": "太阳报", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d82b2-fe6f-11ec-a30b-d4619d029786", "商业", "https://www.bhaskar.com/business/", "政治"),
            ("4a8d8276-fe6f-11ec-a30b-d4619d029786", "国际", "https://www.bhaskar.com/international/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="ba1e62a6"]//li/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="bf64dc76"]/*'
                                   '|//div[@class="f3e032cb"]//img'
                                   '|//div[@class="bf64dc76"]//video/source') or []
        for news_tag in news_tags:
            ...
            if news_tag.root.tag == "source":
                videos = self.parse_media(response, news_tag, "mp4")
                videos and content.append(videos)
        return content
