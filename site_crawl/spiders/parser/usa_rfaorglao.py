...
class USA_rfaorglaoParser(BaseParser):
    name = 'usa_rfaorglao'
    
    # 站点id
    site_id = "63a018b4-9f3c-4380-83e4-ad42973fbb2d"
    # 站点名
    site_name = "自由亚洲电台老挝网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "63a018b4-9f3c-4380-83e4-ad42973fbb2d", "source_name": "自由亚洲电台老挝网", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8ec9f6-fe6f-11ec-a30b-d4619d029786", "东南亚", "https://www.rfa.org/lao/daily/southeastasia/story_archive", "政治"),
            ("4a8ec99c-fe6f-11ec-a30b-d4619d029786", "政治", "https://www.rfa.org/lao/daily/politics/story_archive", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@id="storypagemaincol"]/div[@id="storytext"]/*')
        if news_tags:
