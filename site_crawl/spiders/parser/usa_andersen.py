...
class UsaAnDerDenParser(BaseParser):
    name = 'usa_andersen'
    
    # 站点id
    site_id = "d203985e-7f03-4c1c-939c-02951b2e4767"
    # 站点名
    site_name = "安德森空军基地"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "d203985e-7f03-4c1c-939c-02951b2e4767", "source_name": "安德森空军基地", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("c1f941b9-5b01-3879-aafe-1f08581d05e9", "消息", "", "政治"),
            ("4a8e21d6-fe6f-11ec-a30b-d4619d029786", "消息/文章", "https://www.andersen.af.mil/News/Articles/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section/*')
        if news_tags:
