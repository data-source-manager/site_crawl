...
class ThTdriParser(BaseParser):
    name = 'tdri'
    
    # 站点id
    site_id = "9cca470d-ad62-4e3d-b903-014c833a8edc"
    # 站点名
    site_name = "泰国发展研究院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9cca470d-ad62-4e3d-b903-014c833a8edc", "source_name": "泰国发展研究院", "direction": "th", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d0bde-fe6f-11ec-a30b-d4619d029786", "文章", "https://tdri.or.th/category/read-with-tdri/article/", "政治"),
            ("4a8d0bac-fe6f-11ec-a30b-d4619d029786", "消息", "https://tdri.or.th/category/news-tdri/page/1/", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//h2[@class="main-title"]/text()').extract_first(default="")
