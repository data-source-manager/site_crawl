...
class UsaFpaParser(BaseParser):
    name = 'usa_fpa'
    
    # 站点id
    site_id = "fd67e615-6933-4ed8-902a-982731ae0e38"
    # 站点名
    site_name = "外交政策协会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "fd67e615-6933-4ed8-902a-982731ae0e38", "source_name": "外交政策协会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8e2636-fe6f-11ec-a30b-d4619d029786", "2022重大决策主题", "https://www.fpa.org/great_decisions/?act=gd_topics", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul//div//h4/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//img[@class="left"]|//div[@id="content"]/p')
        if news_tags:
