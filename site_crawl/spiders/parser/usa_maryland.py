...
class UsaMarylandParser(BaseParser):
    name = 'maryland'
    
    # 站点id
    site_id = "4d971a7f-edea-a681-2ba9-97c0ca7318db"
    # 站点名
    site_name = "马里兰州政府网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "4d971a7f-edea-a681-2ba9-97c0ca7318db", "source_name": "马里兰州政府网", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f1b04-fe6f-11ec-a30b-d4619d029786", "新闻", "https://news.maryland.gov/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="rsswidget"]/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//article/*|//article/p/img')
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "em", "strong", "u", "a"]:
