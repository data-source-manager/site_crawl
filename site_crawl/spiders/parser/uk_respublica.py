...
class UkRespublicaParser(BaseParser):
    name = 'respublica'
    
    # 站点id
    site_id = "6613ff0e-8b39-5416-fd36-ad7a3ac6c761"
    # 站点名
    site_name = "雷斯共和"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "6613ff0e-8b39-5416-fd36-ad7a3ac6c761", "source_name": "雷斯共和", "direction": "uk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f87ce-fe6f-11ec-a30b-d4619d029786", "新闻中心", "https://www.respublica.org.uk/press-centre/page/1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ul[@class="blog_archive"]/li/h2/a/@href').extract() or []
        for news_url in list(set(news_urls)):
            if "media-coverage" not in news_url:
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//div[@class="author_comment_blog_wrapper"]/ul/li/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="col9 blog_single wide blog_intro"]/*'
                                   '|//div[@class="content_wrapper clearfix"]//img') or []
