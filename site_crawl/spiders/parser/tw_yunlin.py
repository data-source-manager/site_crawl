...
class TwYunlinParser(BaseParser):
    name = 'yunlin'
    
    # 站点id
    site_id = "f6dbbadd-2880-4468-ae9a-33ebacdbe318"
    # 站点名
    site_name = "云林县政府全球资讯网"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "f6dbbadd-2880-4468-ae9a-33ebacdbe318", "source_name": "云林县政府全球资讯网", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("72a30a44-b428-3291-ade3-ed86bab62b7c", "焦点讯息", "", "政治"),
            ("4a8c8380-fe6f-11ec-a30b-d4619d029786", "焦点讯息/县府新闻", "https://www.yunlin.gov.tw/News.aspx?n=1244&sms=9662&page=1&PageSize=20", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//td/span/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        times_ = response.xpath('//div[@class="group page-footer"]//li[@data-index="1"]/span/text()').extract_first()
        year, mt, day = re.findall('上版日期：(.*)-(\d{2})-(\d{2})', times_)[0]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="div"]//div[@class="p"]/p')
        if news_tags:
