...
class UsaNews_usNiParser(BaseParser):
    name = 'news_usni'
    ...
    channel = [
        ...
        for board_id, board_name, board_url, board_theme in [
            ("1452b91e-db59-23c2-7950-318b8b690502", "舰队和海洋追踪器", "https://news.usni.org/category/fleet-tracker", "军事"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        for news_tag in news_tags:
            ...
            # 解析表格
                ...
                for tr in news_tag.xpath(".//tr"):
                    content.append({
                        "data": "|".join(tr.xpath(".//td//text()").extract()),
                        "type": "text"
                    })
