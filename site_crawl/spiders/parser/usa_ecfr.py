...
class UsaEcFrParser(BaseParser):
    name = 'usa_ecfr'
    
    # 站点id
    site_id = "adfa1f0c-de4a-4eb0-803c-a1bb3c492503"
    # 站点名
    site_name = "欧洲对外关系委员会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "adfa1f0c-de4a-4eb0-803c-a1bb3c492503", "source_name": "欧洲对外关系委员会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f2068-fe6f-11ec-a30b-d4619d029786", "文章", "https://ecfr.eu/articles/page/1/", "政治"),
        ]
    ]
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//ul[@class="dropdown-menu"]/li/a/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//figure/img|//div[@class="text-body tts-input"]/*')
        if news_tags:
