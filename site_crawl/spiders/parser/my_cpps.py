...
class MyCppsParser(BaseParser):
    name = 'cpps'
    
    # 站点id
    site_id = "5ac4c315-1052-4a29-8fd9-927ae52cb42e"
    # 站点名
    site_name = "公共政策研究中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "5ac4c315-1052-4a29-8fd9-927ae52cb42e", "source_name": "公共政策研究中心", "direction": "my", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d0aee-fe6f-11ec-a30b-d4619d029786", "出版物", "https://cpps.org.my/publication/page/1/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="col-md-9 col-sm-12 post"]/div[2]/*')
        if news_tags:
