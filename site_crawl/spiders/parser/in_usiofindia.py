...
class InUsiofindiaParser(BaseParser):
    name = 'usiofindia'
    
    # 站点id
    site_id = "2b162fad-ae86-491c-9fab-4b95e49d95bc"
    # 站点名
    site_name = "印度三军协会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "2b162fad-ae86-491c-9fab-4b95e49d95bc", "source_name": "印度三军协会", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f4462-fe6f-11ec-a30b-d4619d029786", "USI事件", "https://usiofindia.org/past-events/?sf_paged=1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="desc"]/h5/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="single-event-content"]/p/img|//div[@class="single-event-content"]/*')
        if news_tags:
