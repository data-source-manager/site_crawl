...
class UsaHrfParser(BaseParser):
    name = 'usa_hrf'
    
    # 站点id
    site_id = "f23c7beb-48fd-924e-6ae3-3660ec6f71f2"
    # 站点名
    site_name = "美国人权基金会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "f23c7beb-48fd-924e-6ae3-3660ec6f71f2", "source_name": "美国人权基金会", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8df418-fe6f-11ec-a30b-d4619d029786", "消息", "https://hrf.org/news/archive/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="content"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="wpb_text_column wpb_content_element "]/div/*|'
                                   '//div[@class="markdown"]//p|//div[@class="tml body"]/*|'
                                   '//div[@class="content-inner"]/*|//h1[@class="entry-title"]')
        if news_tags:
            for news_tag in news_tags:
                if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "em", "a", "h1"]:
