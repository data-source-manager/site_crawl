...
class TwCtvParser(BaseParser):
    name = 'ctv'
    
    # 站点id
    site_id = "4bc51e56-1cee-4d0f-855b-25149b3f0d92"
    # 站点名
    site_name = "中视全球资讯网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "4bc51e56-1cee-4d0f-855b-25149b3f0d92", "source_name": "中视全球资讯网", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8cc8d6-fe6f-11ec-a30b-d4619d029786", "国际", "http://new.ctv.com.tw/Category/%E5%9C%8B%E9%9A%9B", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="search_result"]/div[@class="list"]/a')
        if news_urls:
            for news_url in news_urls:
                rsp_url = news_url.xpath('./@href').get()
                rsp_time = news_url.xpath('.//div[@class="time"]/text()').get()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="yt"]/iframe|//div[@class="editor"]/*')
        if news_tags:
