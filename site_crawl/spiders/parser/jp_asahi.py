...
class JpAsAhiParser(BaseParser):
    name = 'asahi'
    
    # 站点id
    site_id = "93c0687a-c926-a860-08b7-97ff38771367"
    # 站点名
    site_name = "朝日新闻"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "93c0687a-c926-a860-08b7-97ff38771367", "source_name": "朝日新闻", "direction": "jp", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f96a6-fe6f-11ec-a30b-d4619d029786", "国际", "https://www.asahi.com/international/list/?iref=com_inttop_all_list", "政治"),
            ("4a8f9642-fe6f-11ec-a30b-d4619d029786", "政治", "https://www.asahi.com/politics/list/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="Section SectionFst"]//li/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="nfyQp"]/*'
                                   '|//div[@class="nfyQp"]//img') or []
