...
class UsaMitreParser(BaseParser):
    name = 'usa_mitre'
    
    # 站点id
    site_id = "175fde3c-adc2-44db-a270-af9c3fb38333"
    # 站点名
    site_name = "米特公司"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "175fde3c-adc2-44db-a270-af9c3fb38333", "source_name": "米特公司", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8e2712-fe6f-11ec-a30b-d4619d029786", "新闻稿", "https://www.mitre.org/news/press-releases", "政治"),
        ]
    ]
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//div[@class="meta__tags"]/a/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="field--text-long"]/*|//div[@property="schema:text"]/p')
        if news_tags:
