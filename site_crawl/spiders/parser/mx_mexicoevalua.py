...
class MxMexicoevaluaParser(BaseParser):
    name = 'mexicoevalua'
    
    # 站点id
    site_id = "6ca58562-0520-4836-8c74-f7d89b8fc272"
    # 站点名
    site_name = "墨西哥评估公共政策分析中心"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "6ca58562-0520-4836-8c74-f7d89b8fc272", "source_name": "墨西哥评估公共政策分析中心", "direction": "mx", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d725e-fe6f-11ec-a30b-d4619d029786", "出版物", "https://www.mexicoevalua.org/investigaciones/", "政治"),
            ("4a8d722c-fe6f-11ec-a30b-d4619d029786", "新闻稿", "https://www.mexicoevalua.org/category/comunicado/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h4/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="entry-content post-content mxe-text-center box-bg-color box"]/*'
                                   '|//div[@class="entry-content post-content mxe-text-center box-bg-color box"]//img') or []
