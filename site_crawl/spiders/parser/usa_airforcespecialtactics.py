...
class Usa_airforcespecialtacticsParser(BaseParser):
    name = 'usa_airforcespecialtactics'
    
    # 站点id
    site_id = "1df637a8-5827-4803-aa3d-002e03437eed"
    # 站点名
    site_name = "美国空军特种战术"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "1df637a8-5827-4803-aa3d-002e03437eed", "source_name": "美国空军特种战术", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("912322b6-2f72-11ed-a768-d4619d029786", "消息", "https://www.airforcespecialtactics.af.mil/News/", "政治"),
        ]
    ]
