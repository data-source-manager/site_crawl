...
class UsaWhitehouseParser(BaseParser):
    name = 'whitehouse'
    
    # 站点id
    site_id = "8da2ebb7-5acb-4384-ab48-0a40565c3f4d"
    # 站点名
    site_name = "美国白宫"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8da2ebb7-5acb-4384-ab48-0a40565c3f4d", "source_name": "美国白宫", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8c4348-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.whitehouse.gov/briefing-room/", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        ...
        if title:
            title = title.replace('- The White House', "")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section/div/div/*')
        if news_tags:
