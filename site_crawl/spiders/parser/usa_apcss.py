...
class UsaApcssParser(BaseParser):
    name = 'apcss'
    
    # 站点id
    site_id = "1a1f2a7b-ddb3-416f-9375-63aa9687c2b2"
    # 站点名
    site_name = "亚太安全研究中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "1a1f2a7b-ddb3-416f-9375-63aa9687c2b2", "source_name": "亚太安全研究中心", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("d670725e-71b7-35c1-ac44-022a6ed40f27", "消息", "", "政治"),
            ("4a8e30fe-fe6f-11ec-a30b-d4619d029786", "消息/安全纽带", "https://apcss.org/security-nexus/", "政治"),
            ("4a8e2fb4-fe6f-11ec-a30b-d4619d029786", "消息/新闻", "https://apcss.org/latest-news/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="fusion-post-content post-content"]/h2/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//meta[@property="article:published_time"]/@content|'
                               '//meta[@name="citation_date"]/@content').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//ul[@class="slides"]//img|//div[@class="fusion-text fusion-text-1"]/*|'
                                   '//div[@class="pgcsimplygalleryblock-slider-item-wrap"]/img|'
                                   '//div[@class="fusion-text fusion-text-2"]/*|//div[@class="post-content"]//a|'
                                   '//div[@class="fusion-text fusion-text-1"]//img')
        if news_tags:
