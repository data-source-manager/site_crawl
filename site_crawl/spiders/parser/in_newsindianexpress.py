...
class InNewsiNdiaNexpressParser(BaseParser):
    name = 'newsindianexpress'
    
    # 站点id
    site_id = "4821d40e-6af4-4a0c-b33f-c6cb1e4e510d"
    # 站点名
    site_name = "印度快报网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "4821d40e-6af4-4a0c-b33f-c6cb1e4e510d", "source_name": "印度快报网", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d7a56-fe6f-11ec-a30b-d4619d029786", "头条新闻", "https://newsindianexpress.com/category/top-stories/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="entry-content entry clearfix"]//p'
                                   '|//div[@class="entry-content entry clearfix"]//ol'
                                   '|//div[@class="entry-content entry clearfix"]//ul'
                                   '|//div[@class="featured-area-inner"]//img') or []
    ...
    def get_read_count(self, response) -> int:
        try:
            num = response.xpath('//span[@class="meta-views meta-item "]/text()').extract_first()
