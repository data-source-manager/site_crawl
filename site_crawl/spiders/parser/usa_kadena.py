...
class UsaKaDenaParser(BaseParser):
    name = 'usa_kadena'
    
    # 站点id
    site_id = "9c163757-6224-449f-b967-fc9784b766e9"
    # 站点名
    site_name = "嘉手纳空军基地"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9c163757-6224-449f-b967-fc9784b766e9", "source_name": "嘉手纳空军基地", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("afa9b67f-2197-45b7-86de-5f6f33e9b69f", "最新消息", "https://www.kadena.af.mil/News/", "政治"),
            ("fbcf1fc4-59f1-42af-a884-9cf4c2754ea7", "最新消息/评论", "https://www.kadena.af.mil/News/Commentaries/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id='9c163757-6224-449f-b967-fc9784b766e9'
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//footer/a/text()|//footer/a/font/font/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section/*|//picture/img')
        if news_tags:
