...
class UsaArmy_technologyParser(BaseParser):
    name = 'army-technology'
    # 站点id
    site_id = "d87adf45-afea-494c-a7e0-e635380fda8e"
    # 站点名
    site_name = "陆军技术网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "d87adf45-afea-494c-a7e0-e635380fda8e", "source_name": "陆军技术网", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8e1fba-fe6f-11ec-a30b-d4619d029786", "分析", "https://www.army-technology.com/analysis/", "政治"),
            ("edb904be-05c1-41b8-b379-b0aa9aed1e93", "消息", "https://www.army-technology.com/news/", "政治"),
            ("4aa573fa-eb56-59a1-175c-91fdeda16e82", "部门", "", "政治"),
            ("27859b8e-8af0-49e0-9f6b-6be1fd91a69e", "部门/C4ISR 与电子战", "https://www.army-technology.com/sector/c4isr/", "政治"),
            ("b7176e3d-d283-4586-a89d-279149641f94", "部门/士兵系统", "https://www.army-technology.com/sector/soldier-systems/", "政治"),
            ("60c04a2b-d58f-4834-9bd7-ba0d8c101e1d", "部门/武器", "https://www.army-technology.com/sector/weaponry/", "政治"),
            ("029c6790-f1d9-4a42-b09d-95168b9b9a4c", "部门/陆地平台", "https://www.army-technology.com/sector/land-platforms/", "政治"),
            ("e493cc6a-d594-49f5-9a8c-4be70adb516b", "部门/陆地模拟与训练", "https://www.army-technology.com/sector/land-simulation-and-training/", "政治"),
        ]
    ]
