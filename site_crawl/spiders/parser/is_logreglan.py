...
class IS_logreglanParser(BaseParser):
    name = 'is_logreglan'
    
    # 站点id
    site_id = "e26d1fcd-0796-414c-9713-2e4af6498be6"
    # 站点名
    site_name = "冰岛国家警察"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e26d1fcd-0796-414c-9713-2e4af6498be6", "source_name": "冰岛国家警察", "direction": "is", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("912372b6-2f72-11ed-a768-d4619d029786", "新闻", "https://www.logreglan.is/utgafa/frettir-tilkynningar/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        ...
        news_urls = response.xpath("//h1/a/@href").getall() or []
        if news_urls:
    ...
    def get_tags(self, response) -> list:
        tags_list = []
        tags_node = response.xpath("//div[@class='fretta_tags']/a[@rel='category tag']/text()").getall()
        if tags_node:
    ...
    def get_content_media(self, response) -> list:
        ...
        if news_tags:
            for news_tag in news_tags:
                if news_tag.root.tag in ["h3", "span", "p", "blockquote"] and news_tag.root.get("class",
                                                                                                "") != 'article-meta':
