...
class VnVassParser(BaseParser):
    name = 'vass'
    
    # 站点id
    site_id = "7f555c9b-0fd6-41b8-89c8-1e70df8aaa31"
    # 站点名
    site_name = "越南国家社会科学院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "7f555c9b-0fd6-41b8-89c8-1e70df8aaa31", "source_name": "越南国家社会科学院", "direction": "vn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d20e2-fe6f-11ec-a30b-d4619d029786", "会议", "https://www.vass.gov.vn/hoi-nghi-hoi-thao-1.0.1", "政治"),
            ("4a8d2132-fe6f-11ec-a30b-d4619d029786", "国际合作新闻", "https://www.vass.gov.vn/hop-tac-quoc-te-1.0.1", "政治"),
            ("4a8d216e-fe6f-11ec-a30b-d4619d029786", "行政新闻", "https://www.vass.gov.vn/tin-hanh-chinh-to-chuc-1.0.1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//p[@class="title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        time_ = response.xpath('//p[@class="title_date"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@id="anhnoidungdetail"]/*|//div[@id="anhnoidungdetail"]//img|'
                                   '//div[@class="meta"]/*')
        if news_tags:
