...
class UsaHollywoodreporterParser(BaseParser):
    name = 'hollywoodreporter'
    
    # 站点id
    site_id = "ee000136-8648-45b5-abbc-96d8e2a8c935"
    # 站点名
    site_name = "好莱坞邮报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "ee000136-8648-45b5-abbc-96d8e2a8c935", "source_name": "好莱坞邮报", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("36be65a1-07d0-4be3-a8c9-4c74d5197e51", "新闻", "https://www.hollywoodreporter.com/c/news/page/1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="lrv-a-wrapper"]//h3/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        authors_1 = response.xpath('//div[@class="a-article-grid__author "]//span/text()').extract()
        authors_2 = response.xpath('//a[@class="c-link  "]/text()').extract()
        authors = [a.strip("\n\t") for a in authors_2 or authors_1]
        return authors
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//article[@class="lrv-u-margin-b-2"]/div[1]//img|//article[@class="lrv-u-margin-b-2"]//p') or []
