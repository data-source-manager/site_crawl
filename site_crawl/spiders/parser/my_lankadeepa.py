...
class MyLankadeepaParser(BaseParser):
    name = 'lankadeepa'
    
    # 站点id
    site_id = "292b9b41-bf46-4979-ab14-e94d01c95a97"
    # 站点名
    site_name = "兰卡线上新闻"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "292b9b41-bf46-4979-ab14-e94d01c95a97", "source_name": "兰卡线上新闻", "direction": "my", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d2a10-fe6f-11ec-a30b-d4619d029786", "最新消息", "https://www.lankadeepa.lk/latest_news/1", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//header[@class="post-content"]/*'
                                   '|//header[@class="post-content"]//img') or []
