...
class LaVientianetimeslaoParser(BaseParser):
    name = 'vientianetimeslao'
    
    # 站点id
    site_id = "0b64db0b-b98a-4803-b1ae-cc0b5dd4d912"
    # 站点名
    site_name = "万象时报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "0b64db0b-b98a-4803-b1ae-cc0b5dd4d912", "source_name": "万象时报", "direction": "la", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块主题)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f59b6-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.vientianetimeslao.la/category/%E0%BA%82%E0%BB%88%E0%BA%B2%E0%BA%A7%E0%BA%97%E0%BA%B1%E0%BA%87%E0%BB%9D%E0%BA%BB%E0%BA%94/", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        time_ = response.xpath('//span[@class="published updated"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="entry-content"]/*|'
                                   '//div[@class="entry-thumbnail-area "]/img')
        if news_tags:
