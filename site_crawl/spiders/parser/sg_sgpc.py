...
class SgSgpcParser(BaseParser):
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="press-title"]/p/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//span[@class="press-info-date"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="quote blue rs_skip"]/div[@class="left"]/*|'
                                   '//div[contains(@id,"content")]/div/img|'
                                   '//div[contains(@id,"content")]/div/p')
        if news_tags:
