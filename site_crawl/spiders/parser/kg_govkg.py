...
class KgGovkGParser(BaseParser):
    name = 'govkg'
    
    # 站点id
    site_id = "d9fc5658-3595-40a0-b04c-9758a6a1f0f2"
    # 站点名
    site_name = "吉尔吉斯斯坦政府网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "d9fc5658-3595-40a0-b04c-9758a6a1f0f2", "source_name": "吉尔吉斯斯坦政府网", "direction": "kg", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d21dc-fe6f-11ec-a30b-d4619d029786", "多媒体", "https://www.gov.kg/ky/multimedia", "政治"),
            ("4a8d21aa-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.gov.kg/ky/post/all", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="section-item__title"]/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        time_ = response.xpath('//meta[@property="article:published_timed"]/@content').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="news-inner-img"]/img|//div[@class="news-inner-content"]/*')
        if news_tags:
