...
class BnCspsParser(BaseParser):
    name = 'csps'
    
    # 站点id
    site_id = "40c784e4-d2b9-4255-b636-fb0102dc7013"
    # 站点名
    site_name = "文莱政策和战略研究中心"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "40c784e4-d2b9-4255-b636-fb0102dc7013", "source_name": "文莱政策和战略研究中心", "direction": "bn", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f76bc-fe6f-11ec-a30b-d4619d029786", "新闻发布室", "", "政治"),
            ("eb17b5f9-df9a-5812-99fb-6690cb19503a", "新闻发布室/云集新闻", "http://www.csps.org.bn/press/news/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "40c784e4-d2b9-4255-b636-fb0102dc7013"

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h3[contains(@class,"item-title")]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//h6/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@dir="auto"]/*|'
