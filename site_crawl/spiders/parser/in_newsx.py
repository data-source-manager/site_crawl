...
class InNewsxParser(BaseParser):
    name = 'newsx'
    
    # 站点id
    site_id = "8d9e0e29-dbae-defe-5640-0d63c2318551"
    # 站点名
    site_name = "印度新闻X电视台"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8d9e0e29-dbae-defe-5640-0d63c2318551", "source_name": "印度新闻X电视台", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d8884-fe6f-11ec-a30b-d4619d029786", "世界", "https://www.newsx.com/world/", "政治"),
            ("4a8d8906-fe6f-11ec-a30b-d4619d029786", "区域", "https://www.newsx.com/regional/", "政治"),
            ("4a8d88ca-fe6f-11ec-a30b-d4619d029786", "国内", "https://www.newsx.com/national/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="post-block-style1"]/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//div[@class="post-title"]/p/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//article/*'
                                   '|//article//img'
                                   '|//div[@class="fullimage-single"]//img') or []
