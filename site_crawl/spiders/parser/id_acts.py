...
class IdActsParser(BaseParser):
    name = 'acts'
    
    # 站点id
    site_id = "ff596de9-2f9d-41ee-9d06-8be698043e9c"
    # 站点名
    site_name = "非洲技术研究中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "ff596de9-2f9d-41ee-9d06-8be698043e9c", "source_name": "非洲技术研究中心", "direction": "id", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f4520-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.acts-net.org/news?start=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//p[@class="readmore"]/a/@href').extract() or ""
        if news_urls:
                ...
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag == "ul":
                        for con in news_tag.xpath('./li'):
                            con_file = self.parse_file(response, con.xpath('./a'))
                            if con_file:
