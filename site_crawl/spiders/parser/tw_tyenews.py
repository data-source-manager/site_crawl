...
class TwTyenewsParser(BaseParser):
    name = 'tyenews'
    
    # 站点id
    site_id = "58f3be32-114b-11ec-95a1-aaaa0016f974"
    # 站点名
    site_name = "桃园电子报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "58f3be32-114b-11ec-95a1-aaaa0016f974", "source_name": "桃园电子报", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8c7db8-fe6f-11ec-a30b-d4619d029786", "国际", "https://tyenews.com/international/", "政治"),
            ("bac0f798-09b0-4a1a-a4cf-a7d7baf09b99", "国际/两岸", "https://tyenews.com/crossstrait/", "政治"),
            ("4a8c7c3c-fe6f-11ec-a30b-d4619d029786", "政治", "https://tyenews.com/politic/", "政治"),
            ("89309388-f309-4cc1-ab61-4e91e83e4327", "社会", "https://tyenews.com/society/", "政治"),
            ("a0340c33-dca7-4a55-a3a3-8ff77a0d468c", "经建", "https://tyenews.com/construction/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id='58f3be32-114b-11ec-95a1-aaaa0016f974'
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@data-id="ead9bc6"]/div/*|//div[@data-id="ead9bc6"]/div//img')
        if news_tags:
