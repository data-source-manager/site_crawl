...
class UsaNorthwesterNmutualParser(BaseParser):
    name = 'northwesternmutual'
    
    # 站点id
    site_id = "4d22e200-34f8-1533-633a-f93c2590d748"
    # 站点名
    site_name = "得克萨斯财团"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "4d22e200-34f8-1533-633a-f93c2590d748", "source_name": "得克萨斯财团", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d3d34-fe6f-11ec-a30b-d4619d029786", "新闻", "https://news.northwesternmutual.com/news-releases?o=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="wd_title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        time_ = response.xpath('//span[@class="xn-chron"]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//div[@class="wd_body wd_news_body"]/*|//div[@class="wd_body wd_news_body"]/div/table')
        if news_tags:
