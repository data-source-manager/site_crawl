...
class TwAamacauParser(BaseParser):
    name = 'aamacau'
    
    # 站点id
    site_id = "b5eb5dd7-ad6e-4da0-9696-6061a411ebcf"
    # 站点名
    site_name = "论尽媒体"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "b5eb5dd7-ad6e-4da0-9696-6061a411ebcf", "source_name": "论尽媒体", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("01b32cdb-984d-41dc-86c7-b7924d03e708", "专题报道", "https://aamacau.com/topics/issue/", "政治"),
            ("4a8ee27e-fe6f-11ec-a30b-d4619d029786", "即时报道", "https://aamacau.com/topics/breakingnews/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//post-title/a/@href').extract() or ""
        if news_urls:
            for news_url in list(set(news_urls)):
                yield urljoin(response.url, news_url)

    def get_title(self, response) -> str:
        title = response.xpath('//div[@id="post_title"]/h1/a/text()').extract_first(default="")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@id="contentleft"]/*')
        if news_tags:
