...
class UsaNassauiNstituteParser(BaseParser):
    name = 'nassauinstitute'
    
    # 站点id
    site_id = "08372624-f1a5-4dd0-b878-a12528c9e41a"
    # 站点名
    site_name = "纳苏研究院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "08372624-f1a5-4dd0-b878-a12528c9e41a", "source_name": "纳苏研究院", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("0c8bd6c4-83cb-c625-44e0-4b52864bdac4", "专题", "", "政治"),
            ("4a8d2c5e-fe6f-11ec-a30b-d4619d029786", "专题/政府", "https://www.nassauinstitute.org/category/government/", "政治"),
            ("4a8d2ccc-fe6f-11ec-a30b-d4619d029786", "专题/法律", "https://www.nassauinstitute.org/category/legal/", "政治"),
            ("4a8d2c9a-fe6f-11ec-a30b-d4619d029786", "专题/经济", "https://www.nassauinstitute.org/category/economy/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@id="x-iso-container"]//h2/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="entry-content content"]/*'
                                   '|//div[@class="entry-content content"]//img') or []
