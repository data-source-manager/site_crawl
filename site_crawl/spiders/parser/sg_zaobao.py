...
class SgZaobaoParser(BaseParser):
    name = 'zaobao'
    ...
    channel = [
        {
            ...
            **{"site_id": "943659f7-893b-4369-ad9a-009af093b683", "source_name": "缅甸新光报", "direction": "sg", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("7deba67e-9740-45a0-b7e2-58e00abe2d0a", "中港台即时", "https://www.zaobao.com.sg/realtime/china", "政治"),
            ("325b48c7-049f-49cd-9c18-2af96c999fa7", "新加坡即时", "https://www.zaobao.com.sg/realtime/singapore", "政治"),
            ("97ed04b4-a9c1-458e-84fb-89798f11468d", "财经即时", "https://www.zaobao.com.sg/zfinance/realtime", "政治"),
            ("5d6370c1-d453-4438-b731-16622f07d36b", "际即时", "https://www.zaobao.com.sg/realtime/world", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="article-type-link"]/@href').extract() or ""
        if news_urls:
            for news_url in list(set(news_urls)):
                yield urljoin(response.url, news_url)

    def get_title(self, response) -> str:
        title = response.xpath('//div[@class="article-title"]/h1/text()').extract_first(default="")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="figure-media"]/img|'
