...
class UsaUsaceParser(BaseParser):
    name = 'usace'
    
    # 站点id
    site_id = "67cb2db2-f6f7-4d4c-8c91-e00b4775ee10"
    # 站点名
    site_name = "美国陆军工兵部队，新奥尔良地区"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "67cb2db2-f6f7-4d4c-8c91-e00b4775ee10", "source_name": "美国陆军工兵部队，新奥尔良地区", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("aaf2c651-b999-3eef-a904-7c7824a35614", "媒体", "", "政治"),
            ("91232a22-2f72-11ed-a768-d4619d029786", "媒体/新闻发布", "https://www.mvn.usace.army.mil/Media/News-Releases/", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="da_black"]/*|//div[@class="da_black"]')
        if news_tags:
