...
class IdThehinduParser(BaseParser):
    name = 'thehindu'
    
    # 站点id
    site_id = "cba53987-84e0-689e-dab1-8c028b3e2ad3"
    # 站点名
    site_name = "印度教徒"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "cba53987-84e0-689e-dab1-8c028b3e2ad3", "source_name": "印度教徒", "direction": "id", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f849a-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.thehindu.com/news/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h3[@class="title big"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath('//span[@itemprop="author"]/meta[@itemprop="name"]/@content').extract()
        if authors:
            for au in authors:
                if au.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[contains(@class,"article-picture")]//img|'
