...
class MyMiErParser(BaseParser):
    name = 'my_mier'
    
    # 站点id
    site_id = "66edde2b-5b03-48bc-a46a-63935535464b"
    # 站点名
    site_name = "马来西亚经济研究院"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "66edde2b-5b03-48bc-a46a-63935535464b", "source_name": "马来西亚经济研究院", "direction": "my", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8df486-fe6f-11ec-a30b-d4619d029786", "政策简报", "https://www.mier.org.my/policy-briefs", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="_3Rcdf"]//div[@data-testid="mesh-container-content"]')
        if news_urls:
            for news_url in news_urls:
                rsp_url = news_url.xpath('.//div[@class="_2UgQw"][1]//a/@href').get()
                rsp_title = news_url.xpath('.//span[@style="letter-spacing:0.08em;"]/text()').get()
                rsp_time = news_url.xpath('.//span[@class="color_14"]//span[@style="letter-spacing:0em;"]/text()').get()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@id="comp-kthxep1n"]/*')
        if news_tags:
