...
class HkCableParser(BaseParser):
    name = 'cable'
    
    # 站点id
    site_id = "ff42726d-1cb6-05b7-bcff-93f941c5884b"
    # 站点名
    site_name = "有限宽频"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "ff42726d-1cb6-05b7-bcff-93f941c5884b", "source_name": "有限宽频", "direction": "hk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("82707cff-622b-3267-9c8f-a35562f769e4", "新闻", "", "政治"),
            ("4a8df648-fe6f-11ec-a30b-d4619d029786", "新闻/两岸国际", "https://www.i-cable.com/category/%e5%85%a9%e5%b2%b8%e5%9c%8b%e9%9a%9b", "政治"),
            ("4a8df724-fe6f-11ec-a30b-d4619d029786", "新闻/港闻", "https://www.i-cable.com/category/%e6%b8%af%e8%81%9e", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        # title = response.xpath('//div[@class="zh-h4 single-post-title"]/text()').extract_first(default="")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="post-detail-wrap"]/div/*')
        if news_tags:
