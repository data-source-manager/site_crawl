...
class InSundayguardianliveParser(BaseParser):
    name = 'sundayguardianlive'
    
    # 站点id
    site_id = "325c2e92-0f50-f6cc-51fa-9af6a172fcad"
    # 站点名
    site_name = "印度星期日卫报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "325c2e92-0f50-f6cc-51fa-9af6a172fcad", "source_name": "印度星期日卫报", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d897e-fe6f-11ec-a30b-d4619d029786", "世界", "https://www.sundayguardianlive.com/world", "政治"),
            ("4a8d8938-fe6f-11ec-a30b-d4619d029786", "消息", "https://www.sundayguardianlive.com/news", "政治"),
            ("4a8d89e2-fe6f-11ec-a30b-d4619d029786", "观点", "https://www.sundayguardianlive.com/opinion", "政治"),
        ]
    ]
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//a[@class="editor-name"]/text()').extract()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@id="dvContents"]/*'
                                   '|//div[@id="dvContents"]//img'
                                   '|//div[@id="dvContents2"]//img') or []
