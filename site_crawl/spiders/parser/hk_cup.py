...
class HkCupParser(BaseParser):
    name = 'cup'

    # 站点id
    site_id = "79b07c78-42a8-4693-a5b5-69c507f500da"
    # 站点名
    site_name = "CUP"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "79b07c78-42a8-4693-a5b5-69c507f500da", "source_name": "CUP", "direction": "hk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块主题)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8cce4e-fe6f-11ec-a30b-d4619d029786", "新闻回带", "https://www.cup.com.hk/archive/", "政治"),
            ("4a8cce80-fe6f-11ec-a30b-d4619d029786", "政治趋势", "https://www.cup.com.hk/topic/politics-economics/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//ol/li/a/@href|//h2[@itemprop="headline"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//figure/img|//div[@class="post-content"]/*|//div[@class="post-content"]//img|'
                                   '//div[@class="wpb_video_wrapper"]/iframe|//div[@class="wpb_wrapper"]/*')
        if news_tags:
