...
class TwNcccParser(BaseParser):
    name = 'ncc'
    
    # 站点id
    site_id = "e184c4b6-e95f-4b9e-bd82-6a14fea4120e"
    # 站点名
    site_name = "国家通讯传播委员会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "e184c4b6-e95f-4b9e-bd82-6a14fea4120e", "source_name": "国家通讯传播委员会", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("b0c1ebfa-7218-11ed-a54c-d4619d029786", "新闻稿", "https://www.ncc.gov.tw/chinese/news.aspx?site_content_sn=8&is_history=0", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[contains(@class,"list")]/ul/li/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="edit"]/*')
        if news_tags:
