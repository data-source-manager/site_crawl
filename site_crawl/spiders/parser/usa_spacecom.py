...
class UsaSpacecomParser(BaseParser):
    name = 'spacecom'
    
    # 站点id
    site_id = "6c265530-4333-4112-9a35-68cd38cde858"
    # 站点名
    site_name = "太空司令部"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "6c265530-4333-4112-9a35-68cd38cde858", "source_name": "太空司令部", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("16dd812e-8755-4039-8564-5eb9830605f1", "新闻", "https://www.spacecom.mil/newsroom/news/", "政治"),
            ("d5823de4-7035-48e1-ac71-2204d0a20ffd", "演讲", "https://www.spacecom.mil/Newsroom/Speeches/", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = "".join(response.xpath('//div[@class="category-date"]/text()').extract())
        if time_:
            if "|" in time_:
