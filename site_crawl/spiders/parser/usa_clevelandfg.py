...
class UsaClevelandfgParser(BaseParser):
    name = 'clevelandfg'
    
    # 站点id
    site_id = "9fd00f9f-e887-8a07-7999-3a81132e0907"
    # 站点名
    site_name = "克利夫兰财团"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "9fd00f9f-e887-8a07-7999-3a81132e0907", "source_name": "克利夫兰财团", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f06e6-fe6f-11ec-a30b-d4619d029786", "文章", "https://www.clevelandfg.com/resource-center/articles", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="list-content"]/ul/li/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="c-matter__body"]/p/img|//div[@class="c-matter__body"]/*|'
                                   '//div[@id="infographic"]/img|//div[@class="content-area"]/p|'
                                   '//div[@class="col-half content-image"]/img|'
                                   '//div[@class="description ng-binding ng-scope"]/p|'
                                   '//div[@class="title_paragraph sect_paragraph"]/p')
        if news_tags:
