...
class BtKuenselonlineParser(BaseParser):
    name = 'kuenselonline'
    
    # 站点id
    site_id = "ab87f2ea-b428-4972-92c9-be0b5e08e826"
    # 站点名
    site_name = "不丹库恩塞尔报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "ab87f2ea-b428-4972-92c9-be0b5e08e826", "source_name": "不丹库恩塞尔报", "direction": "bt", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f2806-fe6f-11ec-a30b-d4619d029786", "新闻", "https://kuenselonline.com/category/news/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="content"]//h5/a/@href').extract() or []
    ...
    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//div[@class="page-header-details"]/span[1]/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="content-wrapper"]/*'
                                   '|//div[@class="content-wrapper"]//img'
                                   '|//div[@class="container"]/img') or []
