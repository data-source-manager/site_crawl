...
class Kp_38northParser(BaseParser):
    name = 'kp_38north'
    
    # 站点id
    site_id = "7f6f497d-7120-72d0-9560-6bf2917d7336"
    # 站点名
    site_name = "38度线"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "7f6f497d-7120-72d0-9560-6bf2917d7336", "source_name": "38度线", "direction": "kp", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f982c-fe6f-11ec-a30b-d4619d029786", "内政", "https://www.38north.org/topics/domestic-affairs/page/1/", "政治"),
            ("9a522024-5027-4c1b-af30-9388aa5f0b79", "军事", "https://www.38north.org/topics/military-affairs/page/1/", "政治"),
            ("93f4157e-1fca-440d-8e66-29acf037fe4d", "外政", "https://www.38north.org/topics/foreign-affairs/page/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="article__link"]/@href').extract() or ""
        if news_urls:
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath('//li[@class="meta--authors"]//a/text()').extract()
        if authors:
            for au in authors:
                if au.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="content"]/section/*')
        if news_tags:
