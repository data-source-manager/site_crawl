...
class XZ_tibetsunParser(BaseParser):
    name = 'xz_tibetsun'
    '''
    文章一年未更新
    '''
    ...
    # 站点id
    site_id = "bf2e475e-4460-4d64-b507-1961e9837b43"
    # 站点名
    site_name = "西藏太阳新闻"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "bf2e475e-4460-4d64-b507-1961e9837b43", "source_name": "西藏太阳新闻", "direction": "xz", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8dc5d8-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.tibetsun.com/archives/news", "政治"),
            ("4a8dc632-fe6f-11ec-a30b-d4619d029786", "有你的发言权", "https://www.tibetsun.com/archives/have_your_say", "政治"),
            ("4a8dc696-fe6f-11ec-a30b-d4619d029786", "采访", "https://www.tibetsun.com/archives/interviews", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath("//span[@class='entry-title']/a/@href").extract() or []
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        Date_str = response.xpath("//p[@id='dateline']/text()").get()
        if Date_str:
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath("//div[@id='post-content']/*")
        if news_tags:
