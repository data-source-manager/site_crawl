...
class UsaFiveThirtyEightParser(BaseParser):
    name = 'usa_fivethirtyeight'
    
    # 站点id
    site_id = "f191bf9d-feb8-4ee1-8c8d-d72e5c8b78d3"
    # 站点名
    ...
    channel = [
        {
            ...
            **{"site_id": "f191bf9d-feb8-4ee1-8c8d-d72e5c8b78d3", "source_name": "Fivethirtyeight", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8dba66-fe6f-11ec-a30b-d4619d029786", "政治", "https://fivethirtyeight.com/politics/", "政治"),
            ("4a8dbad4-fe6f-11ec-a30b-d4619d029786", "视频", "https://fivethirtyeight.com/videos/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "f191bf9d-feb8-4ee1-8c8d-d72e5c8b78d3"

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h2[@class="article-title entry-title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//p[@class="tag-links"]/a/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="bug-container"]|//div[@class="entry-content single-post-content"]/*|'
                                   '//table[@class="viz full"]|//div[@class="container"]/*|'
                                   '//iframe[@class="abc-player"]')
        if news_tags:
