...
class InCarnegieindiaParser(BaseParser):
    name = 'carnegieindia'
    
    # 站点id
    site_id = "11905cb0-627a-40db-a37a-98ee08c112f5"
    # 站点名
    site_name = "卡内基印度中心"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "11905cb0-627a-40db-a37a-98ee08c112f5", "source_name": "卡内基印度中心", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8db444-fe6f-11ec-a30b-d4619d029786", "出版物", "https://carnegieindia.org/publications/", "政治"),
        ]
    ]
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//meta[@name="title"]/@content|'
    ...
    def get_pub_time(self, response) -> str:
        ...
        time_ = response.xpath('//div[@class="post-date col col-25"]/ul/li[1]/text()|'
    ...
    def get_tags(self, response) -> list:
        ...
        tags = response.xpath('//ul[@class="clean-list gutter-bottom list-across-divided"]/li/a/text()|'
                              '//ul[@class="tdb-tags"]/li/a/text()').extract()
        if tags:
            for tag in tags:
                if tag.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="article-body"]/*|//figure/img|//div[@class="gutter-top__double"]/p|'
                                   '//div[@class="tdb-block-inner td-fix-index"]/p/*|//div[@class="XoRJR _9YsLN"]/img|'
                                   '//span[@class="custom-caption"]/img|//div[@id="pcl-full-content"]/p|'
                                   '//div[@class="paywall"]//div[@class="_2Uddg"]/*|//picture/img|'
                                   '//div[@class="paywall"]//div[@class="_2Uddg"]|//div[@id="content-body-66111242"]/*')
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag in ["h2", "h3", "h4", "h5", "span", "p", "sup", "div"]:
