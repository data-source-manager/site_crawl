...
class XzTibeTexpressParser(BaseParser):
    name = 'tibetexpress'
    
    # 站点id
    site_id = "36496106-9016-4246-9e80-e1f3938542f1"
    # 站点名
    site_name = "西藏快报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "36496106-9016-4246-9e80-e1f3938542f1", "source_name": "西藏快报", "direction": "xz", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f509c-fe6f-11ec-a30b-d4619d029786", "世界", "http://tibetexpress.net/category/news/world/page/1/", "政治"),
            ("0d52d39f-8cfe-4169-8894-a81bfa328945", "其他新闻", "http://tibetexpress.net/category/news/other-news/", "政治"),
            ("cb97d648-9e0d-4f0f-8ecf-e67f300863d6", "流亡", "http://tibetexpress.net/category/news/exile/", "政治"),
            ("2796bf62-5d9c-4460-8aa0-f863b2906f1e", "西藏", "http://tibetexpress.net/category/news/tibet/", "政治"),
            ("49c527b2-0b43-4c93-8c5a-caa24872c852", "访谈", "http://tibetexpress.net/category/interviews/", "政治"),
        ]
    ]
        ...
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag == "img" or news_tag.root.tag == "figure":
                        if news_tag.root.tag == "figure":
                            news_tag = news_tag.xpath(".//img")
    ...
    def get_like_count(self, response) -> int:
        return re.findall("\d+", response.xpath('//span[@class="total-views"]/text()').extract_first())[0]
