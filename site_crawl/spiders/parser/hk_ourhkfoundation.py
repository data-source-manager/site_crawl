...
class HkOurhkfOundatiOnParser(BaseParser):
    name = 'ourhkfoundation'
    
    # 站点id
    site_id = "c8812d75-268c-4818-a5f5-809884773850"
    # 站点名
    site_name = "团结香港基金会"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "c8812d75-268c-4818-a5f5-809884773850", "source_name": "团结香港基金会", "direction": "hk", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("832c2487-191e-4460-8470-8e0648f33529", "两地经济", "https://www.ourhkfoundation.org.hk/zh-hant/research/mainlandhk-economies?tid=38", "政治"),
            ("4a8cd83a-fe6f-11ec-a30b-d4619d029786", "文章", "https://www.ourhkfoundation.org.hk/zh-hant/reports/20", "政治"),
            ("4a8cd7c2-fe6f-11ec-a30b-d4619d029786", "新闻发布", "https://www.ourhkfoundation.org.hk/zh-hant/coverage-and-news/65", "政治"),
            ("815cf700-0ff0-4fdf-9935-d51beba4164a", "经济", "https://www.ourhkfoundation.org.hk/zh-hant/research/economic-development?tid=37", "政治"),
            ("4a8cd8b2-fe6f-11ec-a30b-d4619d029786", "讲辞", "https://www.ourhkfoundation.org.hk/zh-hant/reports/21", "政治"),
        ]
    ]
    ...
    def get_pub_time(self, response) -> str:
        time_ = response.xpath('//div[@class="date"]/text()|//div[contains(@class,"post-date")]/text()').extract_first()
        if time_:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="body"]/*|//div[@class="body"]//img|'
                                   '//div[@class="region region-content"]//iframe')
        if news_tags:
