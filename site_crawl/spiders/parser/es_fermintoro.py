...
class EsFermintoroParser(BaseParser):
    name = 'fermintoro'
    
    # 站点id
    site_id = "7b7da836-65e5-4869-878b-e2ea7c5a5d3f"
    # 站点名
    site_name = "费明托罗议会研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "7b7da836-65e5-4869-878b-e2ea7c5a5d3f", "source_name": "费明托罗议会研究所", "direction": "es", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d8b22-fe6f-11ec-a30b-d4619d029786", "事件", "https://fermintoro.net/portal/category/eventos/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//header[@class="entry-header"]/h2/a/@href').extract() or []
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="entry-content clearfix"]/*'
