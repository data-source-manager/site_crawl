...
class UsaSalonParser(BaseParser):
    name = 'salon'
    
    # 站点id
    site_id = "8488a6bd-4436-4b46-ad4d-63ca9788cb22"
    # 站点名
    site_name = "沙龙"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8488a6bd-4436-4b46-ad4d-63ca9788cb22", "source_name": "沙龙", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d4568-fe6f-11ec-a30b-d4619d029786", "新闻与政治", "https://www.salon.com/category/news-and-politics", "政治"),
            ("4a8d45d6-fe6f-11ec-a30b-d4619d029786", "沙龙谈政治", "https://www.salon.com/tv/salon_talks_politics", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="card-article"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//section[@class="cover-wrapper"]/img|//article[@id="article-content"]/*|'
                                   '//div[@id="full_video_description"]')
        if news_tags:
            for news_tag in news_tags:
                if type(news_tag.root) == str:
                    ...
                    if news_tag.root.tag in ["h2", "h3", "h5", "span", "p", "a", "em", "div"]:
