...
class UsaCmsParser(BaseParser):
    name = 'usa_cms'
    
    # 站点id
    site_id = "be7984a0-d905-af2f-c353-aaf4fd4a8750"
    # 站点名
    site_name = "美国医疗保险和医疗补助服务中心"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "be7984a0-d905-af2f-c353-aaf4fd4a8750", "source_name": "美国医疗保险和医疗补助服务中心", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f0e48-fe6f-11ec-a30b-d4619d029786", "新闻稿", "https://www.cms.gov/newsroom?page=0", "政治"),
        ]
    ]
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="node__content clearfix"]/div[2]/*')
        if news_tags:
