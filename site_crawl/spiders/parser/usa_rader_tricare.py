...
class RaderParser(BaseParser):
    name = 'rader'
    
    # 站点id
    site_id = "d6e9ef87-5fd7-4bea-b2d6-e68cdfe90d59"
    # 站点名
    site_name = "安德鲁雷德美国陆军健康诊所"
    # 板块信息
    channel = [
        {
            # 板块默认字段(站点id, 站点名, 站点地区)
            **{"site_id": "d6e9ef87-5fd7-4bea-b2d6-e68cdfe90d59", "source_name": "安德鲁雷德美国陆军健康诊所", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("91233a94-2f72-11ed-a768-d4619d029786", "文章", "https://rader.tricare.mil/News-Gallery/Articles", "政治"),
        ]
    ]
