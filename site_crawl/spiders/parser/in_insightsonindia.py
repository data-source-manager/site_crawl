...
class InInsIghtsonIndIaParser(BaseParser):
    name = 'insightsonindia'
    
    # 站点id
    site_id = "4a27ed6f-d58c-4f44-c176-9ee37d98bd4b"
    # 站点名
    site_name = "印度内幕网"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "4a27ed6f-d58c-4f44-c176-9ee37d98bd4b", "source_name": "印度内幕网", "direction": "in", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8f95d4-fe6f-11ec-a30b-d4619d029786", "每日时事", "https://www.insightsonindia.com/insights-ias-upsc-current-affairs/1/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="entry-content"]/div[2]/div[1]//li/a/@href').extract() or []
