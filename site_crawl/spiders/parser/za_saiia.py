...
class ZaSaiiaParser(BaseParser):
    name = 'saiia'
    
    # 站点id
    site_id = "8d4e1680-35a4-4e96-ac8c-7c36ad3a0033"
    # 站点名
    site_name = "南非国际事务研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8d4e1680-35a4-4e96-ac8c-7c36ad3a0033", "source_name": "南非国际事务研究所", "direction": "za", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d27d6-fe6f-11ec-a30b-d4619d029786", "对外政策", "https://saiia.org.za/thematic-area/foreign-policy/", "政治"),
            ("4a8d288a-fe6f-11ec-a30b-d4619d029786", "治理", "https://saiia.org.za/thematic-area/governance/", "政治"),
            ("4a8d2830-fe6f-11ec-a30b-d4619d029786", "经济外交", "https://saiia.org.za/thematic-area/economic-diplomacy/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="col-md-4"]//h3/a/@href').extract() or []
    ...
    def get_author(self, response) -> list:
        authors = response.xpath('//div[@class="post-info"]/div[1]/div/a/text()').extract()
        return [a.strip() for a in authors]

    def get_pub_time(self, response) -> str:
        try:
            _time = response.xpath('//div[@class="elementor-widget-container"]/h3[1]/text()').extract()[-1]
    ...
    def get_content_media(self, response) -> list:
        content = []
        news_tags = response.xpath('//div[@class="elementor-widget-container"]/*'
                                   '|//div[@class="elementor-image"]/figure/img') or []
