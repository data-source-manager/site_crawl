...
class UsaLexingtoninstituteParser(BaseParser):
    name = 'lexingtoninstitute'
    
    # 站点id
    site_id = "b5a090cf-8080-7fd4-c4f6-642a5d74c10b"
    # 站点名
    site_name = "列克星敦研究所"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "b5a090cf-8080-7fd4-c4f6-642a5d74c10b", "source_name": "列克星敦研究所", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8dd28a-fe6f-11ec-a30b-d4619d029786", "新闻", "https://www.lexingtoninstitute.org/in-the-news/", "政治"),
            ("4a8dd24e-fe6f-11ec-a30b-d4619d029786", "防御", "https://www.lexingtoninstitute.org/category/defense/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//span[@class="ewb_title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_title(self, response) -> str:
        title = response.xpath('//h1[@class="entry-title"]/text()|'
                               '//h1[@class="entry-title"]/strong/text()').extract_first(default="")
    ...
    def get_pub_time(self, response) -> str:
        ...
        if "in-the-news" in response.url:
            times_ = response.xpath('//script[@class="yoast-schema-graph"]/text()').extract_first()
            time_ = re.findall('},"datePublished":"(.*)","dateModified', times_)[0]
            if time_:
