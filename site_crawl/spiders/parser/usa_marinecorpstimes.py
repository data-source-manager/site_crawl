...
class UsaMarinecorpstiMesParser(BaseParser):
    name = 'marinecorpstimes'
    
    # 站点id
    site_id = "0f3a02c5-6105-4219-a9e9-2eb837126f5a"
    # 站点名
    site_name = "海军陆战队时报"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "0f3a02c5-6105-4219-a9e9-2eb837126f5a", "source_name": "海军陆战队时报", "direction": "usa", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("0fe1ddb2-e85c-43f1-87aa-f646c8bf20e5", "部分", "", "政治"),
            ("9aa38f87-3068-4c07-ac3b-ce0b650e2bb4", "部分/新闻", "https://www.marinecorpstimes.com/news/", "政治"),
            ("88476c62-daf1-465c-a047-562984888c8c", "部分/新闻/你的海军陆战队", "https://www.marinecorpstimes.com/news/your-marine-corps/", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//h5[@itemprop="headline"]/a/@href|'
                                   '//h6[@itemprop="headline"]/a/@href').extract() or ""
        if news_urls:
            for news_url in list(set(news_urls)):
                yield urljoin(response.url, news_url)

    def get_title(self, response) -> str:
        title = response.xpath('//title[@itemprop="headline"]/text()').extract_first(default="")
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[contains(@class,"articleHeader__leadArt")]/figure|'
                                   '//div[@data-gtm-name="Article Body"]/article/*')
        if news_tags:
    ...
    def parse_single_img(self, response, news_tag):
        ...
        img_src = news_tag.xpath(".//img/@src").extract_first()
