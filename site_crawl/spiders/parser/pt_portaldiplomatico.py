...
class PT_portaldiplomaticoParser(BaseParser):
    name = 'pt_portaldiplomatico'
    
    # 站点id
    site_id = "2010f192-bbf9-43f2-b8b4-14b65bc0b577"
    # 站点名
    site_name = "葡萄牙外交部"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "2010f192-bbf9-43f2-b8b4-14b65bc0b577", "source_name": "葡萄牙外交部", "direction": "pt", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("91236b04-2f72-11ed-a768-d4619d029786", "新闻稿", "https://portaldiplomatico.mne.gov.pt/comunicacao-e-media/comunciados-de-imprensa", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath("//div[@class='page-header']/h2//@href").extract() or []
        if news_urls:
    ...
    def get_title(self, response) -> str:
        title = response.xpath("//div[@class='page-header']/h2/text()").extract_first(default="")
