...
class TwTaipeiParser(BaseParser):
    name = 'taipei'
    
    # 站点id
    site_id = "01f0c2f7-116f-4338-962c-7344d101a902"
    # 站点名
    site_name = "台北市政府"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "01f0c2f7-116f-4338-962c-7344d101a902", "source_name": "台北市政府", "direction": "tw", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("e7009c50-7607-11ed-ad4d-d4619d029786", "市府新闻稿", "https://www.gov.taipei/News.aspx?n=F0DDAF49B89E9413&sms=72544237BBE4C5F6", "政治"),
        ]
    ]
    ...
    def get_repost_source(self, response) -> str:
        return response.xpath('//div[@class="list-text detail"]//span/text()').extract_first()
