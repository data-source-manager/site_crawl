...
class ItBitterwinterParser(BaseParser):
    name = 'bitterwinter'
    
    # 站点id
    site_id = "8431751e-e5af-4186-a270-afa9fe5a9f14"
    # 站点名
    site_name = "寒冬"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "8431751e-e5af-4186-a270-afa9fe5a9f14", "source_name": "寒冬", "direction": "it", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8cf1b2-fe6f-11ec-a30b-d4619d029786", "新闻", "https://zh.bitterwinter.org/category/news/", "政治"),
            ("4a8cf1e4-fe6f-11ec-a30b-d4619d029786", "纪实", "https://zh.bitterwinter.org/category/testimonies/", "政治"),
            ("4a8cf216-fe6f-11ec-a30b-d4619d029786", "访谈", "https://zh.bitterwinter.org/category/interviews/", "政治"),
            ("4a8cf252-fe6f-11ec-a30b-d4619d029786", "评论", "https://zh.bitterwinter.org/category/editorials/", "政治"),
        ]
    ]
    
    def __init__(self):
        BaseParser.__init__(self)
        self.site_id = "8431751e-e5af-4186-a270-afa9fe5a9f14"

    def parse_list(self, response) -> list:
        news_urls = response.xpath('//a[@class="entry-title-link"]/@href').extract() or ""
        if news_urls:
    ...
    def get_author(self, response) -> list:
        ...
        authors = response.xpath('//span[@class="entry-author-name"]/text()').extract()
        if authors:
            for au in authors:
                if au.strip():
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath(
            '//div[@class="entry-content clearfix"]/*|//div[@class="entry-content clearfix"]//img')
        if news_tags:
