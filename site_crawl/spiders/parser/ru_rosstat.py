...
class RuRosstatParser(BaseParser):
    name = 'rosstat'
    
    # 站点id
    site_id = "1ce0e4f0-bfc9-4583-a1bd-cc37667724b9"
    # 站点名
    site_name = "俄罗斯联邦统计署"
    # 板块信息
    channel = [
        {
            ...
            **{"site_id": "1ce0e4f0-bfc9-4583-a1bd-cc37667724b9", "source_name": "俄罗斯联邦统计署", "direction": "ru", "if_front_position": False}, 
            # (板块id, 板块名, 板块URL, 板块类型)
            **{"board_id": board_id, "site_board_name": board_name, "url": board_url, "board_theme": board_theme}
        }
        for board_id, board_name, board_url, board_theme in [
            ("4a8d13ea-fe6f-11ec-a30b-d4619d029786", "统计局新闻", "https://rosstat.gov.ru/folder/313?page=1", "政治"),
        ]
    ]
    ...
    def parse_list(self, response) -> list:
        news_urls = response.xpath('//div[@class="news-card__title"]/a/@href').extract() or ""
        if news_urls:
    ...
    def get_pub_time(self, response) -> str:
        times_ = response.xpath('//div[@class="article-info"]/div[1]/div/text()').extract_first()
    ...
    def get_content_media(self, response) -> list:
        ...
        news_tags = response.xpath('//div[@class="content"]/*')
        if news_tags:
